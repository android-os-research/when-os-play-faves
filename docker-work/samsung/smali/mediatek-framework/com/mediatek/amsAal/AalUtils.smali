...
# static fields
.field private static final blacklist AAL_DEFAULT_LEVEL:I = 0x80

.field private static final blacklist AAL_MAX_LEVEL:I = 0x100

.field private static final blacklist AAL_MIN_LEVEL:I = 0x0

.field public static final blacklist AAL_MODE_BALANCE:I = 0x1

.field public static final blacklist AAL_MODE_LOWPOWER:I = 0x2

.field public static final blacklist AAL_MODE_PERFORMANCE:I = 0x0

.field public static final blacklist AAL_MODE_SIZE:I = 0x3

.field private static final blacklist AAL_NULL_LEVEL:I = -0x1

.field private static final blacklist TAG:Ljava/lang/String; = "AalUtils"

.field private static blacklist sAalConfigXMLPath:Ljava/lang/String;

.field private static blacklist sDebug:Z

.field private static blacklist sEnabled:Z

.field private static blacklist sInstance:Lcom/mediatek/amsAal/AalUtils;

.field private static blacklist sIsAalSupported:Z


# instance fields
.field private blacklist mAalMode:I

.field private blacklist mConfig:Ljava/util/Map;
...
.field private blacklist mCurrentConfig:Lcom/mediatek/amsAal/AalUtils$AalConfig;


# direct methods
.method static bridge synthetic blacklist -$$Nest$mmodeToString(Lcom/mediatek/amsAal/AalUtils;I)Ljava/lang/String;
    .registers 2
...
.method constructor blacklist <init>()V
    ...
    :try_end_23
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_20 .. :try_end_23} :catch_54
...
.method private blacklist dumpDebugUsageInternal()Ljava/lang/String;
    .registers 3
...
.method private declared-synchronized blacklist dumpInternal()Ljava/lang/String;
    .registers 8
...
.method private blacklist ensureBacklightLevel(I)I
    .registers 6
    .param p1, "level"    # I
...
.method private blacklist getAalConfig(Lcom/mediatek/amsAal/AalUtils$AalIndex;)Lcom/mediatek/amsAal/AalUtils$AalConfig;
    .registers 5
...
.method public static blacklist getInstance()Lcom/mediatek/amsAal/AalUtils;
    .registers 1
...
.method private blacklist modeToString(I)Ljava/lang/String;
    .registers 4
    .param p1, "mode"    # I
...
.method private blacklist parseXML()V
    .registers 10
...
.method private declared-synchronized blacklist setDebugInternal(Z)Ljava/lang/String;
    .registers 4
    .param p1, "debug"    # Z
...
.method private native blacklist setSmartBacklightStrength(I)V
.end method

.method private declared-synchronized blacklist setSmartBacklightTableInternal(Ljava/lang/String;I)Ljava/lang/String;
    .registers 4
...
.method private declared-synchronized blacklist setSmartBacklightTableInternal(Ljava/lang/String;II)Ljava/lang/String;
    .registers 8
    .param p1, "name"    # Ljava/lang/String;
    .param p2, "value"    # I
    .param p3, "mode"    # I
    ...
    move-result-object v1
    :try_end_69
    .catchall {:try_start_18 .. :try_end_69} :catchall_89
    ...
    invoke-static {v1, v0}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_87
    .catchall {:try_start_6b .. :try_end_87} :catchall_89
...
# virtual methods
.method public blacklist dump(Ljava/io/PrintWriter;[Ljava/lang/String;I)I
    .registers 10
...
.method public blacklist onAfterActivityResumed(Ljava/lang/String;Ljava/lang/String;)V
    .registers 4
...
.method public blacklist onUpdateSleep(ZZ)V
    .registers 5
...
.method declared-synchronized blacklist setAalModeInternal(I)Ljava/lang/String;
    .registers 5
    .param p1, "mode"    # I
    ...
    invoke-static {v1, v0}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_10
    .catchall {:try_start_1 .. :try_end_10} :catchall_66
...
.method public declared-synchronized blacklist setDefaultSmartBacklightInternal(Ljava/lang/String;)V
    .registers 6
    ...
    :try_end_40
    .catchall {:try_start_12 .. :try_end_40} :catchall_42
...
.method public declared-synchronized blacklist setEnabledInternal(Z)V
    .registers 5
    .param p1, "enabled"    # Z
...
.method public declared-synchronized blacklist setSmartBacklightInternal(Landroid/content/ComponentName;)V
    .registers 3
...
.method public declared-synchronized blacklist setSmartBacklightInternal(Landroid/content/ComponentName;I)V
    .registers 9
    .param p1, "name"    # Landroid/content/ComponentName;
    .param p2, "mode"    # I
    ...
    invoke-static {v0, v1}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_10
    .catchall {:try_start_1 .. :try_end_10} :catchall_e0
    ...
    invoke-direct {p0, v1}, Lcom/mediatek/amsAal/AalUtils;->setSmartBacklightStrength(I)V
    :try_end_c0
    .catchall {:try_start_19 .. :try_end_c0} :catchall_e0
    ...
    invoke-static {v0, v1}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_de
    .catchall {:try_start_c2 .. :try_end_de} :catchall_e0
