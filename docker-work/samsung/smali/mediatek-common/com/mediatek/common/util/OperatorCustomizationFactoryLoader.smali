...
# static fields
.field private static final blacklist CUSTOM_APK_PATH:Ljava/lang/String; = "/custom/app/"

.field private static final blacklist CUSTOM_JAR_PATH:Ljava/lang/String; = "/custom/operator/libs/"

.field private static final blacklist LOG_ENABLE:Z

.field private static final blacklist PRODUCT_APK_PATH:Ljava/lang/String; = "/product/app/"

.field private static final blacklist PRODUCT_JAR_PATH:Ljava/lang/String; = "/product/operator/libs/"

.field private static final blacklist PROPERTY_OPERATOR_OPTR:Ljava/lang/String; = "persist.vendor.operator.optr"

.field private static final blacklist PROPERTY_OPERATOR_SEG:Ljava/lang/String; = "persist.vendor.operator.seg"

.field private static final blacklist PROPERTY_OPERATOR_SPEC:Ljava/lang/String; = "persist.vendor.operator.spec"

.field private static final blacklist RSC_PRODUCT_APK_PATH:Ljava/lang/String;

.field private static final blacklist RSC_SYSTEM_APK_PATH:Ljava/lang/String;

.field private static final blacklist RSC_SYSTEM_EXT_APK_PATH:Ljava/lang/String;

.field private static final blacklist SYSTEM_APK_PATH:Ljava/lang/String; = "/system/app/"

.field private static final blacklist SYSTEM_EXT_APK_PATH:Ljava/lang/String; = "/system_ext/app/"

.field private static final blacklist SYSTEM_EXT_JAR_PATH:Ljava/lang/String; = "/system_ext/operator/libs/"

.field private static final blacklist SYSTEM_JAR_PATH:Ljava/lang/String; = "/system/operator/libs/"

.field private static final blacklist TAG:Ljava/lang/String; = "OperatorCustomizationFactoryLoader"

.field private static final blacklist USP_PACKAGE:Ljava/lang/String;

.field private static final blacklist sFactoryMap:Ljava/util/Map;
...
.method private static blacklist findOpertorFactoryInfo(Ljava/util/List;I)Lcom/mediatek/common/util/OperatorCustomizationFactoryLoader$OperatorFactoryInfo;
    .registers 9
    .param p1, "slot"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    invoke-static {v1}, Lcom/mediatek/common/util/OperatorCustomizationFactoryLoader$OperatorInfo;->-$$Nest$fgetmOperator(Lcom/mediatek/common/util/OperatorCustomizationFactoryLoader$OperatorInfo;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/mediatek/common/util/OperatorCustomizationFactoryLoader$OperatorInfo;->-$$Nest$fgetmSegment(Lcom/mediatek/common/util/OperatorCustomizationFactoryLoader$OperatorInfo;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/mediatek/common/util/OperatorCustomizationFactoryLoader$OperatorInfo;->-$$Nest$fgetmSpecification(Lcom/mediatek/common/util/OperatorCustomizationFactoryLoader$OperatorInfo;)Ljava/lang/String;
...
.method private static blacklist getActiveOperatorInfo()Lcom/mediatek/common/util/OperatorCustomizationFactoryLoader$OperatorInfo;
    .registers 5
...
.method private static blacklist getActiveOperatorInfo(I)Lcom/mediatek/common/util/OperatorCustomizationFactoryLoader$OperatorInfo;
    .registers 8
    .param p0, "slot"    # I
...
.method private static blacklist getSysProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .registers 11
    ...
    :try_end_2a
    .catch Ljava/lang/ClassNotFoundException; {:try_start_4 .. :try_end_2a} :catch_6e
    .catch Ljava/lang/NoSuchMethodException; {:try_start_4 .. :try_end_2a} :catch_58
    .catch Ljava/lang/IllegalAccessException; {:try_start_4 .. :try_end_2a} :catch_42
...
.method public static blacklist loadFactory(Landroid/content/Context;Ljava/util/List;)Ljava/lang/Object;
    .registers 3
...
.method public static declared-synchronized blacklist loadFactory(Landroid/content/Context;Ljava/util/List;I)Ljava/lang/Object;
    .registers 5
    .param p0, "context"    # Landroid/content/Context;
    .param p2, "slot"    # I
    .annotation system Ldalvik/annotation/Signature;
...
.method private static declared-synchronized blacklist loadFactory(Ljava/lang/ClassLoader;Landroid/content/Context;Ljava/util/List;I)Ljava/lang/Object;
    .registers 11
    ...
    invoke-static {v2}, Lcom/mediatek/common/util/OperatorCustomizationFactoryLoader;->logE(Ljava/lang/String;)V
    :try_end_b
    .catchall {:try_start_6 .. :try_end_b} :catchall_b3
    ...
    :try_end_6a
    .catchall {:try_start_d .. :try_end_6a} :catchall_b3
    ...
    invoke-static {v1}, Lcom/mediatek/common/util/OperatorCustomizationFactoryLoader;->logD(Ljava/lang/String;)V
    :try_end_94
    .catchall {:try_start_6c .. :try_end_94} :catchall_b3
    ...
    move-result v6
    :try_end_a0
    .catchall {:try_start_96 .. :try_end_a0} :catchall_b3
    ...
    :try_end_b1
    .catchall {:try_start_a4 .. :try_end_b1} :catchall_b3
...
.method public static blacklist loadFactory(Ljava/lang/ClassLoader;Ljava/util/List;)Ljava/lang/Object;
    .registers 3
    .param p0, "clazzLoader"    # Ljava/lang/ClassLoader;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public static blacklist loadFactory(Ljava/lang/ClassLoader;Ljava/util/List;I)Ljava/lang/Object;
    .registers 4
    .param p0, "clazzLoader"    # Ljava/lang/ClassLoader;
    .param p2, "slot"    # I
    .annotation system Ldalvik/annotation/Signature;
...
.method private static blacklist loadFactoryInternal(Ljava/lang/ClassLoader;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;
    .registers 12
    .param p0, "clazzLoader"    # Ljava/lang/ClassLoader;
    .param p1, "context"    # Landroid/content/Context;
    ...
    move-result v3
    :try_end_81
    .catch Ljava/lang/Exception; {:try_start_38 .. :try_end_81} :catch_3e
    ...
    move-result-object v0
    :try_end_9e
    .catch Ljava/lang/NoSuchMethodException; {:try_start_86 .. :try_end_9e} :catch_a6
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_86 .. :try_end_9e} :catch_9f
    .catch Ljava/lang/Exception; {:try_start_86 .. :try_end_9e} :catch_3e
    ...
    move-result-object v0
    :try_end_b0
    .catch Ljava/lang/Exception; {:try_start_a0 .. :try_end_b0} :catch_3e
...
.method private static blacklist searchTargetPath(Ljava/lang/String;)Ljava/lang/String;
    .registers 14
