...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/health/V2_1/IHealthInfoCallback;
    ...
    .line 29
    check-cast v2, Landroid/hardware/health/V2_1/IHealthInfoCallback;

    return-object v2

    .line 32
    :cond_13
    new-instance v2, Landroid/hardware/health/V2_1/IHealthInfoCallback$Proxy;

    invoke-direct {v2, p0}, Landroid/hardware/health/V2_1/IHealthInfoCallback$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 35
    :try_start_18
    invoke-interface {v2}, Landroid/hardware/health/V2_1/IHealthInfoCallback;->interfaceChain()Ljava/util/ArrayList;
...
.method public static castFrom(Landroid/os/IHwInterface;)Landroid/hardware/health/V2_1/IHealthInfoCallback;
    ...
    invoke-static {p0}, Landroid/hardware/health/V2_1/IHealthInfoCallback;->asInterface(Landroid/os/IHwBinder;)Landroid/hardware/health/V2_1/IHealthInfoCallback;
