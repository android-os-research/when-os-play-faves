...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/health/V2_1/IHealth;
    ...
    .line 44
    check-cast v2, Landroid/hardware/health/V2_1/IHealth;

    return-object v2

    .line 47
    :cond_13
    new-instance v2, Landroid/hardware/health/V2_1/IHealth$Proxy;

    invoke-direct {v2, p0}, Landroid/hardware/health/V2_1/IHealth$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 50
    :try_start_18
    invoke-interface {v2}, Landroid/hardware/health/V2_1/IHealth;->interfaceChain()Ljava/util/ArrayList;
...
.method public static castFrom(Landroid/os/IHwInterface;)Landroid/hardware/health/V2_1/IHealth;
    ...
    invoke-static {p0}, Landroid/hardware/health/V2_1/IHealth;->asInterface(Landroid/os/IHwBinder;)Landroid/hardware/health/V2_1/IHealth;
