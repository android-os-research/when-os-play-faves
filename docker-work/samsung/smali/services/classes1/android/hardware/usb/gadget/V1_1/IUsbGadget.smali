...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/usb/gadget/V1_1/IUsbGadget;
    ...
    .line 21
    check-cast v2, Landroid/hardware/usb/gadget/V1_1/IUsbGadget;

    return-object v2

    .line 24
    :cond_13
    new-instance v2, Landroid/hardware/usb/gadget/V1_1/IUsbGadget$Proxy;

    invoke-direct {v2, p0}, Landroid/hardware/usb/gadget/V1_1/IUsbGadget$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 27
    :try_start_18
    invoke-interface {v2}, Landroid/hardware/usb/gadget/V1_1/IUsbGadget;->interfaceChain()Ljava/util/ArrayList;
...
.method public static castFrom(Landroid/os/IHwInterface;)Landroid/hardware/usb/gadget/V1_1/IUsbGadget;
    ...
    invoke-static {p0}, Landroid/hardware/usb/gadget/V1_1/IUsbGadget;->asInterface(Landroid/os/IHwBinder;)Landroid/hardware/usb/gadget/V1_1/IUsbGadget;
