...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/boot/V1_1/IBootControl;
    ...
    .line 21
    check-cast v2, Landroid/hardware/boot/V1_1/IBootControl;

    return-object v2

    .line 24
    :cond_13
    new-instance v2, Landroid/hardware/boot/V1_1/IBootControl$Proxy;

    invoke-direct {v2, p0}, Landroid/hardware/boot/V1_1/IBootControl$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 27
    :try_start_18
    invoke-interface {v2}, Landroid/hardware/boot/V1_1/IBootControl;->interfaceChain()Ljava/util/ArrayList;
...
.method public static castFrom(Landroid/os/IHwInterface;)Landroid/hardware/boot/V1_1/IBootControl;
    ...
    invoke-static {p0}, Landroid/hardware/boot/V1_1/IBootControl;->asInterface(Landroid/os/IHwBinder;)Landroid/hardware/boot/V1_1/IBootControl;
