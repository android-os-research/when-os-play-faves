...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 71
    new-instance v4, Landroid/hardware/biometrics/fingerprint/V2_1/FingerprintIterator;

    invoke-direct {v4}, Landroid/hardware/biometrics/fingerprint/V2_1/FingerprintIterator;-><init>()V
    ...
    .line 72
    invoke-virtual {v4, p0, v1, v5, v6}, Landroid/hardware/biometrics/fingerprint/V2_1/FingerprintIterator;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v3, Landroid/hardware/biometrics/fingerprint/V2_1/FingerprintIterator;

    mul-int/lit8 v5, v4, 0xc

    int-to-long v5, v5

    invoke-virtual {v3, v2, v5, v6}, Landroid/hardware/biometrics/fingerprint/V2_1/FingerprintIterator;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v3, Landroid/hardware/biometrics/fingerprint/V2_1/FingerprintIterator;
    ...
    .line 25
    :cond_11
    check-cast p1, Landroid/hardware/biometrics/fingerprint/V2_1/FingerprintIterator;

    .line 26
    iget-object v2, p0, Landroid/hardware/biometrics/fingerprint/V2_1/FingerprintIterator;->finger:Landroid/hardware/biometrics/fingerprint/V2_1/FingerprintFingerId;

    iget-object v3, p1, Landroid/hardware/biometrics/fingerprint/V2_1/FingerprintIterator;->finger:Landroid/hardware/biometrics/fingerprint/V2_1/FingerprintFingerId;
    ...
    .line 29
    :cond_1e
    iget p0, p0, Landroid/hardware/biometrics/fingerprint/V2_1/FingerprintIterator;->remainingTemplates:I

    iget p1, p1, Landroid/hardware/biometrics/fingerprint/V2_1/FingerprintIterator;->remainingTemplates:I
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iput p1, p0, Landroid/hardware/biometrics/fingerprint/V2_1/FingerprintIterator;->remainingTemplates:I
