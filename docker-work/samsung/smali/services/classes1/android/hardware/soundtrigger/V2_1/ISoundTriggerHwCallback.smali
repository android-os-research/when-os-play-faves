...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/hardware/soundtrigger/V2_1/ISoundTriggerHwCallback$Proxy;,
...
# static fields
.field public static final kInterfaceName:Ljava/lang/String; = "android.hardware.soundtrigger@2.1::ISoundTriggerHwCallback"
...
.method public static castFrom(Landroid/os/IHwInterface;)Landroid/hardware/soundtrigger/V2_1/ISoundTriggerHwCallback;
    .registers 1
    ...
    invoke-static {p0}, Landroid/hardware/soundtrigger/V2_1/ISoundTriggerHwCallback;->asInterface(Landroid/os/IHwBinder;)Landroid/hardware/soundtrigger/V2_1/ISoundTriggerHwCallback;
...
.method public static getService()Landroid/hardware/soundtrigger/V2_1/ISoundTriggerHwCallback;
    .registers 1
    ...
    .line 87
    invoke-static {v0}, Landroid/hardware/soundtrigger/V2_1/ISoundTriggerHwCallback;->getService(Ljava/lang/String;)Landroid/hardware/soundtrigger/V2_1/ISoundTriggerHwCallback;
...
.method public static getService(Ljava/lang/String;)Landroid/hardware/soundtrigger/V2_1/ISoundTriggerHwCallback;
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public static getService(Ljava/lang/String;Z)Landroid/hardware/soundtrigger/V2_1/ISoundTriggerHwCallback;
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public static getService(Z)Landroid/hardware/soundtrigger/V2_1/ISoundTriggerHwCallback;
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    .line 67
    invoke-static {v0, p0}, Landroid/hardware/soundtrigger/V2_1/ISoundTriggerHwCallback;->getService(Ljava/lang/String;Z)Landroid/hardware/soundtrigger/V2_1/ISoundTriggerHwCallback;
