...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 600
    new-instance v4, Landroid/hardware/soundtrigger/V2_0/ISoundTriggerHwCallback$ModelEvent;

    invoke-direct {v4}, Landroid/hardware/soundtrigger/V2_0/ISoundTriggerHwCallback$ModelEvent;-><init>()V
    ...
    .line 601
    invoke-virtual {v4, p0, v1, v5, v6}, Landroid/hardware/soundtrigger/V2_0/ISoundTriggerHwCallback$ModelEvent;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v3, Landroid/hardware/soundtrigger/V2_0/ISoundTriggerHwCallback$ModelEvent;

    mul-int/lit8 v5, v4, 0x18

    int-to-long v5, v5

    invoke-virtual {v3, v2, v5, v6}, Landroid/hardware/soundtrigger/V2_0/ISoundTriggerHwCallback$ModelEvent;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    .line 653
    iget v4, p0, Landroid/hardware/soundtrigger/V2_0/ISoundTriggerHwCallback$ModelEvent;->status:I
    ...
    .line 654
    iget v4, p0, Landroid/hardware/soundtrigger/V2_0/ISoundTriggerHwCallback$ModelEvent;->model:I

    invoke-virtual {p1, v2, v3, v4}, Landroid/os/HwBlob;->putInt32(JI)V

    .line 656
    iget-object v2, p0, Landroid/hardware/soundtrigger/V2_0/ISoundTriggerHwCallback$ModelEvent;->data:Ljava/util/ArrayList;
    ...
    .line 661
    iget-object v4, p0, Landroid/hardware/soundtrigger/V2_0/ISoundTriggerHwCallback$ModelEvent;->data:Ljava/util/ArrayList;
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    .line 630
    invoke-virtual {p0, v0, v1, v2}, Landroid/hardware/soundtrigger/V2_0/ISoundTriggerHwCallback$ModelEvent;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
