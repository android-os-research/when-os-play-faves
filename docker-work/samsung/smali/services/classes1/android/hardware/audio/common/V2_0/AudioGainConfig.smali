...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 93
    new-instance v4, Landroid/hardware/audio/common/V2_0/AudioGainConfig;

    invoke-direct {v4}, Landroid/hardware/audio/common/V2_0/AudioGainConfig;-><init>()V
    ...
    .line 94
    invoke-virtual {v4, p0, v1, v5, v6}, Landroid/hardware/audio/common/V2_0/AudioGainConfig;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v3, Landroid/hardware/audio/common/V2_0/AudioGainConfig;

    mul-int/lit16 v5, v4, 0x90

    int-to-long v5, v5

    invoke-virtual {v3, v2, v5, v6}, Landroid/hardware/audio/common/V2_0/AudioGainConfig;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    .line 29
    :cond_11
    check-cast p1, Landroid/hardware/audio/common/V2_0/AudioGainConfig;

    .line 30
    iget v2, p0, Landroid/hardware/audio/common/V2_0/AudioGainConfig;->index:I

    iget v3, p1, Landroid/hardware/audio/common/V2_0/AudioGainConfig;->index:I
    ...
    iget v3, p1, Landroid/hardware/audio/common/V2_0/AudioGainConfig;->mode:I
    ...
    iget v3, p1, Landroid/hardware/audio/common/V2_0/AudioGainConfig;->channelMask:I
    ...
    iget-object v3, p1, Landroid/hardware/audio/common/V2_0/AudioGainConfig;->values:[I
    ...
    .line 42
    :cond_33
    iget p0, p0, Landroid/hardware/audio/common/V2_0/AudioGainConfig;->rampDurationMs:I

    iget p1, p1, Landroid/hardware/audio/common/V2_0/AudioGainConfig;->rampDurationMs:I
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iput p1, p0, Landroid/hardware/audio/common/V2_0/AudioGainConfig;->index:I
    ...
    iput p1, p0, Landroid/hardware/audio/common/V2_0/AudioGainConfig;->mode:I
    ...
    iput p1, p0, Landroid/hardware/audio/common/V2_0/AudioGainConfig;->channelMask:I
    ...
    .line 109
    iget-object p1, p0, Landroid/hardware/audio/common/V2_0/AudioGainConfig;->values:[I
    ...
    iput p1, p0, Landroid/hardware/audio/common/V2_0/AudioGainConfig;->rampDurationMs:I
