...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4}, Lcom/android/server/backup/restore/RestorePolicy;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/android/server/backup/restore/RestorePolicy;->ACCEPT:Lcom/android/server/backup/restore/RestorePolicy;

    .line 25
    new-instance v3, Lcom/android/server/backup/restore/RestorePolicy;

    const-string v5, "ACCEPT_IF_APK"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/android/server/backup/restore/RestorePolicy;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/android/server/backup/restore/RestorePolicy;->ACCEPT_IF_APK:Lcom/android/server/backup/restore/RestorePolicy;

    const/4 v5, 0x3

    new-array v5, v5, [Lcom/android/server/backup/restore/RestorePolicy;
    ...
    .line 22
    sput-object v5, Lcom/android/server/backup/restore/RestorePolicy;->$VALUES:[Lcom/android/server/backup/restore/RestorePolicy;
