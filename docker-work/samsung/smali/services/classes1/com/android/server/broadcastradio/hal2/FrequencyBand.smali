...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4}, Lcom/android/server/broadcastradio/hal2/FrequencyBand;-><init>(Ljava/lang/String;I)V
    ...
    const-string v5, "AM_LW"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/android/server/broadcastradio/hal2/FrequencyBand;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/android/server/broadcastradio/hal2/FrequencyBand;->AM_LW:Lcom/android/server/broadcastradio/hal2/FrequencyBand;

    .line 26
    new-instance v5, Lcom/android/server/broadcastradio/hal2/FrequencyBand;

    const-string v7, "AM_MW"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/android/server/broadcastradio/hal2/FrequencyBand;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/android/server/broadcastradio/hal2/FrequencyBand;->AM_MW:Lcom/android/server/broadcastradio/hal2/FrequencyBand;

    .line 27
    new-instance v7, Lcom/android/server/broadcastradio/hal2/FrequencyBand;

    const-string v9, "AM_SW"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/android/server/broadcastradio/hal2/FrequencyBand;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/android/server/broadcastradio/hal2/FrequencyBand;->AM_SW:Lcom/android/server/broadcastradio/hal2/FrequencyBand;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/android/server/broadcastradio/hal2/FrequencyBand;
    ...
    .line 22
    sput-object v9, Lcom/android/server/broadcastradio/hal2/FrequencyBand;->$VALUES:[Lcom/android/server/broadcastradio/hal2/FrequencyBand;
