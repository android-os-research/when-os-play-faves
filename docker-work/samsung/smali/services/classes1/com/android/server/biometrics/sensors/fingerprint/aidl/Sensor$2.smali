.class public Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor;-><init>(Ljava/lang/String;Lcom/android/server/biometrics/sensors/fingerprint/aidl/FingerprintProvider;Landroid/content/Context;Landroid/os/Handler;Landroid/hardware/fingerprint/FingerprintSensorPropertiesInternal;Lcom/android/server/biometrics/sensors/LockoutResetDispatcher;Lcom/android/server/biometrics/sensors/fingerprint/GestureAvailabilityDispatcher;Lcom/android/server/biometrics/log/BiometricContext;)V
.end annotation
...
# direct methods
.method public static synthetic $r8$lambda$GAxsV9xMKFCQ0QEVBLJh0RkqXUs(Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;)V
    .registers 1

    invoke-direct {p0}, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;->lambda$getStopUserClient$0()V

    return-void
.end method

.method public static synthetic $r8$lambda$ZBSlLG32x0WpSzqAvOIX9Okl0hw(Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$HalSessionCallback;ILcom/android/server/biometrics/sensors/fingerprint/aidl/FingerprintProvider;ILandroid/hardware/biometrics/fingerprint/ISession;I)V
    .registers 7

    invoke-direct/range {p0 .. p6}, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;->lambda$getStartUserClient$1(Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$HalSessionCallback;ILcom/android/server/biometrics/sensors/fingerprint/aidl/FingerprintProvider;ILandroid/hardware/biometrics/fingerprint/ISession;I)V
...
.method public constructor <init>(Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor;Lcom/android/server/biometrics/log/BiometricContext;Lcom/android/server/biometrics/sensors/LockoutResetDispatcher;Lcom/android/server/biometrics/sensors/fingerprint/aidl/FingerprintProvider;)V
    ...
    .line 603
    iput-object p1, p0, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;->this$0:Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor;

    iput-object p2, p0, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;->val$biometricContext:Lcom/android/server/biometrics/log/BiometricContext;

    iput-object p3, p0, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;->val$lockoutResetDispatcher:Lcom/android/server/biometrics/sensors/LockoutResetDispatcher;

    iput-object p4, p0, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;->val$provider:Lcom/android/server/biometrics/sensors/fingerprint/aidl/FingerprintProvider;
...
.method private synthetic lambda$getStartUserClient$1(Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$HalSessionCallback;ILcom/android/server/biometrics/sensors/fingerprint/aidl/FingerprintProvider;ILandroid/hardware/biometrics/fingerprint/ISession;I)V
    .registers 10

    .line 665
    iget-object v0, p0, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;->this$0:Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor;
    ...
    invoke-static {v0, v1}, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor;->-$$Nest$fputmCurrentSession(Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor;Lcom/android/server/biometrics/sensors/fingerprint/aidl/AidlSession;)V
    ...
    iget-object p5, p0, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;->this$0:Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor;
...
.method public getStartUserClient(I)Lcom/android/server/biometrics/sensors/StartUserClient;
    ...
    .line 618
    new-instance v11, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$HalSessionCallback;

    iget-object v1, p0, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;->this$0:Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor;
    ...
    iget-object v9, p0, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;->val$lockoutResetDispatcher:Lcom/android/server/biometrics/sensors/LockoutResetDispatcher;

    new-instance v10, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2$1;

    invoke-direct {v10, p0}, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2$1;-><init>(Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;)V
    ...
    .line 663
    iget-object v1, p0, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;->val$provider:Lcom/android/server/biometrics/sensors/fingerprint/aidl/FingerprintProvider;

    new-instance v10, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2$$ExternalSyntheticLambda1;

    invoke-direct {v10, p0, v11, v0, v1}, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$HalSessionCallback;ILcom/android/server/biometrics/sensors/fingerprint/aidl/FingerprintProvider;)V
    ...
    new-instance v3, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2$$ExternalSyntheticLambda2;

    invoke-direct {v3, v1}, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/biometrics/sensors/fingerprint/aidl/FingerprintProvider;)V
    ...
    iget-object v8, p0, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;->val$biometricContext:Lcom/android/server/biometrics/log/BiometricContext;
...
.method public getStopUserClient(I)Lcom/android/server/biometrics/sensors/StopUserClient;
    ...
    iget-object v7, p0, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;->val$biometricContext:Lcom/android/server/biometrics/log/BiometricContext;

    new-instance v8, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2$$ExternalSyntheticLambda0;

    invoke-direct {v8, p0}, Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/biometrics/sensors/fingerprint/aidl/Sensor$2;)V
