...
.method public synthetic constructor <init>(Lcom/android/server/blob/BlobMetadata;Lcom/android/server/blob/BlobMetadata$Accessor;Landroid/os/RevocableFileDescriptor;)V
    ...
    iput-object p1, p0, Lcom/android/server/blob/BlobMetadata$$ExternalSyntheticLambda4;->f$0:Lcom/android/server/blob/BlobMetadata;

    iput-object p2, p0, Lcom/android/server/blob/BlobMetadata$$ExternalSyntheticLambda4;->f$1:Lcom/android/server/blob/BlobMetadata$Accessor;

    iput-object p3, p0, Lcom/android/server/blob/BlobMetadata$$ExternalSyntheticLambda4;->f$2:Landroid/os/RevocableFileDescriptor;
...
.method public final onClose(Ljava/io/IOException;)V
    ...
    iget-object v0, p0, Lcom/android/server/blob/BlobMetadata$$ExternalSyntheticLambda4;->f$0:Lcom/android/server/blob/BlobMetadata;

    iget-object v1, p0, Lcom/android/server/blob/BlobMetadata$$ExternalSyntheticLambda4;->f$1:Lcom/android/server/blob/BlobMetadata$Accessor;

    iget-object p0, p0, Lcom/android/server/blob/BlobMetadata$$ExternalSyntheticLambda4;->f$2:Landroid/os/RevocableFileDescriptor;
