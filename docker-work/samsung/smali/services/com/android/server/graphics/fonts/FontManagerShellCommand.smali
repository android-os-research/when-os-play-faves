...
# static fields
.field public static final MAX_SIGNATURE_FILE_SIZE_BYTES:I = 0x2000

.field public static final TAG:Ljava/lang/String; = "FontManagerShellCommand"
...
.method public static parseFontFamilyUpdateXml(Ljava/io/InputStream;)Ljava/util/List;
    ...
    throw p0
    :try_end_6e
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_6e} :catch_6f
...
.method public final execCommand(Landroid/os/ShellCommand;Ljava/lang/String;)I
    ...
    move-result p0
    :try_end_83
    .catch Lcom/android/server/graphics/fonts/FontManagerService$SystemFontException; {:try_start_a .. :try_end_83} :catch_84
    ...
    .sparse-switch
        ...
        -0x31ffc737 -> :sswitch_40
        0x2f39f4 -> :sswitch_36
        0x5a5b64d -> :sswitch_2c
        0x416a9e0f -> :sswitch_21
        0x43adc8e8 -> :sswitch_16
    .end sparse-switch
.end method
...
.method public final update(Landroid/os/ShellCommand;)I
    ...
    move-result-object v1
    :try_end_16
    .catch Ljava/io/IOException; {:try_start_12 .. :try_end_16} :catch_a3
    ...
    move-result-object v0
    :try_end_1a
    .catchall {:try_start_16 .. :try_end_1a} :catchall_97
    ...
    :try_end_29
    .catch Ljava/io/IOException; {:try_start_20 .. :try_end_29} :catch_6e
    ...
    move-result v7
    :try_end_37
    .catchall {:try_start_29 .. :try_end_37} :catchall_64
    ...
    :try_end_3c
    .catch Ljava/io/IOException; {:try_start_39 .. :try_end_3c} :catch_6e
    .catchall {:try_start_39 .. :try_end_3c} :catchall_8b
    ...
    :try_end_4b
    .catchall {:try_start_3c .. :try_end_4b} :catchall_8b
    ...
    throw p0
    :try_end_8b
    .catchall {:try_start_6f .. :try_end_8b} :catchall_8b
...
.method public final updateFamily(Landroid/os/ShellCommand;)I
    ...
    invoke-virtual {v0}, Landroid/os/ParcelFileDescriptor;->close()V
    :try_end_1d
    .catch Ljava/io/IOException; {:try_start_1a .. :try_end_1d} :catch_3a
