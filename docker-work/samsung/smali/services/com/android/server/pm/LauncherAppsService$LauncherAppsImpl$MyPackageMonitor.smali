...
# direct methods
.method public static synthetic $r8$lambda$pnuIR5iHcwa65dDWU7P3tO9CrSE(Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl$MyPackageMonitor;Ljava/lang/String;I)V
    .registers 3
...
.method public onPackageAdded(Ljava/lang/String;I)V
    ...
    move-result v7
    :try_end_57
    .catchall {:try_start_34 .. :try_end_57} :catchall_104
    ...
    invoke-static {v7, p1, v6}, Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;->-$$Nest$misPackageVisibleToListener(Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;Ljava/lang/String;Lcom/android/server/pm/LauncherAppsService$BroadcastCookie;)Z
    ...
    invoke-static {v4, v5}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_c8
    .catchall {:try_start_61 .. :try_end_c8} :catchall_104
    ...
    :try_end_f9
    .catch Landroid/os/RemoteException; {:try_start_c9 .. :try_end_f9} :catch_fa
    .catchall {:try_start_c9 .. :try_end_f9} :catchall_104
    ...
    :try_end_100
    .catchall {:try_start_fb .. :try_end_100} :catchall_104
...
.method public onPackageChanged(Ljava/lang/String;Landroid/os/UserHandle;)V
    ...
    invoke-static {v4, p1, v3}, Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;->-$$Nest$misPackageVisibleToListener(Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;Ljava/lang/String;Lcom/android/server/pm/LauncherAppsService$BroadcastCookie;)Z

    move-result v3
    :try_end_39
    .catchall {:try_start_d .. :try_end_39} :catchall_4b
...
.method public onPackagesAvailable([Ljava/lang/String;)V
    ...
    invoke-static {v5, p1, v4}, Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;->-$$Nest$mgetFilteredPackageNames(Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;[Ljava/lang/String;Lcom/android/server/pm/LauncherAppsService$BroadcastCookie;)[Ljava/lang/String;
    ...
    move-result v5
    :try_end_46
    .catchall {:try_start_16 .. :try_end_46} :catchall_5c
...
.method public onPackagesSuspended([Ljava/lang/String;)V
    ...
    .line 1871
    invoke-static {v7, p1, v6}, Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;->-$$Nest$mgetFilteredPackageNames(Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;[Ljava/lang/String;Lcom/android/server/pm/LauncherAppsService$BroadcastCookie;)[Ljava/lang/String;

    move-result-object v7
    :try_end_7e
    .catchall {:try_start_52 .. :try_end_7e} :catchall_c0
    ...
    invoke-static {v9, v10, v6}, Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;->-$$Nest$misPackageVisibleToListener(Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;Ljava/lang/String;Lcom/android/server/pm/LauncherAppsService$BroadcastCookie;)Z
    ...
    :try_end_b2
    .catch Landroid/os/RemoteException; {:try_start_7e .. :try_end_b2} :catch_b5
    .catchall {:try_start_7e .. :try_end_b2} :catchall_c0
...
.method public onPackagesUnsuspended([Ljava/lang/String;)V
    ...
    move-result v5
    :try_end_46
    .catchall {:try_start_16 .. :try_end_46} :catchall_58
    ...
    invoke-static {v4, v5, v3}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_55
    .catchall {:try_start_4e .. :try_end_55} :catchall_58
...
.method public final onShortcutChangedInner(Ljava/lang/String;I)V
    ...
    :try_end_14
    .catch Ljava/lang/RuntimeException; {:try_start_10 .. :try_end_14} :catch_ce
    ...
    invoke-static {v3, v15, v2}, Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;->-$$Nest$misPackageVisibleToListener(Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;Ljava/lang/String;Lcom/android/server/pm/LauncherAppsService$BroadcastCookie;)Z
    ...
    :try_end_7c
    .catch Ljava/lang/RuntimeException; {:try_start_18 .. :try_end_7c} :catch_be
    .catchall {:try_start_18 .. :try_end_7c} :catchall_ba
    ...
    move-result-object v2
    :try_end_96
    .catch Ljava/lang/RuntimeException; {:try_start_92 .. :try_end_96} :catch_b5
    ...
    :try_end_9b
    .catch Landroid/os/RemoteException; {:try_start_96 .. :try_end_9b} :catch_a3
    .catch Ljava/lang/RuntimeException; {:try_start_96 .. :try_end_9b} :catch_b5
    ...
    .catch Ljava/lang/RuntimeException; {:try_start_9d .. :try_end_a0} :catch_b5
    ...
    :try_end_ab
    .catch Ljava/lang/RuntimeException; {:try_start_a6 .. :try_end_ab} :catch_b5
    ...
    :try_end_d7
    .catchall {:try_start_d0 .. :try_end_d7} :catchall_cc
