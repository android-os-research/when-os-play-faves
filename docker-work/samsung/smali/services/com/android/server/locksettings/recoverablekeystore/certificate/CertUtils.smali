...
# static fields
.field public static final CERT_FORMAT:Ljava/lang/String; = "X.509"

.field public static final CERT_PATH_ALG:Ljava/lang/String; = "PKIX"

.field public static final CERT_STORE_ALG:Ljava/lang/String; = "Collection"

.field public static final MUST_EXIST_AT_LEAST_ONE:I = 0x2

.field public static final MUST_EXIST_EXACTLY_ONE:I = 0x1

.field public static final MUST_EXIST_UNENFORCED:I = 0x0

.field public static final SIGNATURE_ALG:Ljava/lang/String; = "SHA256withRSA"
...
.method public static buildCertPath(Ljava/security/cert/PKIXParameters;)Ljava/security/cert/CertPath;
    ...
    move-result-object p0
    :try_end_e
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_6 .. :try_end_e} :catch_f
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_6 .. :try_end_e} :catch_f
...
.method public static buildPkixParams(Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/security/cert/X509Certificate;)Ljava/security/cert/PKIXParameters;
    ...
    :try_end_21
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_16 .. :try_end_21} :catch_47
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_16 .. :try_end_21} :catch_40
    ...
    :try_end_2e
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_29 .. :try_end_2e} :catch_39
...
.method public static decodeCert(Ljava/io/InputStream;)Ljava/security/cert/X509Certificate;
    ...
    :try_end_c
    .catch Ljava/security/cert/CertificateException; {:try_start_6 .. :try_end_c} :catch_d
...
.method public static validateCert(Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/security/cert/X509Certificate;)Ljava/security/cert/CertPath;
    ...
    move-result-object p2
    :try_end_e
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_8 .. :try_end_e} :catch_19
    ...
    :try_end_11
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_e .. :try_end_11} :catch_12
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_e .. :try_end_11} :catch_12
...
.method public static verifyRsaSha256Signature(Ljava/security/PublicKey;[B[B)V
    ...
    move-result-object v0
    :try_end_6
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_0 .. :try_end_6} :catch_22
    ...
    throw p0
    :try_end_1b
    .catch Ljava/security/InvalidKeyException; {:try_start_6 .. :try_end_1b} :catch_1b
    .catch Ljava/security/SignatureException; {:try_start_6 .. :try_end_1b} :catch_1b
