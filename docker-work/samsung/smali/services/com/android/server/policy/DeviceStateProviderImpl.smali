...
# static fields
.field public static final CONFIG_FILE_NAME:Ljava/lang/String; = "device_state_configuration.xml"

.field public static final DATA_CONFIG_FILE_PATH:Ljava/lang/String; = "system/devicestate/"
...
.field public static final FLAG_APP_INACCESSIBLE:Ljava/lang/String; = "FLAG_APP_INACCESSIBLE"

.field public static final FLAG_CANCEL_OVERRIDE_REQUESTS:Ljava/lang/String; = "FLAG_CANCEL_OVERRIDE_REQUESTS"

.field public static final TAG:Ljava/lang/String; = "DeviceStateProviderImpl"

.field public static final TRUE_BOOLEAN_SUPPLIER:Ljava/util/function/BooleanSupplier;

.field public static final VENDOR_CONFIG_FILE_PATH:Ljava/lang/String; = "etc/devicestate/"


# instance fields
.field public final mContext:Landroid/content/Context;

.field public mFoldStatePolicy:Lcom/android/server/policy/FoldStatePolicy;

.field public mFoldingSensorPolicy:Lcom/android/server/policy/FoldingSensorPolicy;
...
.method public static parseConfig(Lcom/android/server/policy/DeviceStateProviderImpl$ReadableConfig;)Lcom/android/server/policy/devicestate/config/DeviceStateConfig;
    ...
    move-result-object p0
    :try_end_4
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_4} :catch_2c
    .catch Ljavax/xml/datatype/DatatypeConfigurationException; {:try_start_0 .. :try_end_4} :catch_2c
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_0 .. :try_end_4} :catch_2c
    ...
    .catch Ljavax/xml/datatype/DatatypeConfigurationException; {:try_start_12 .. :try_end_15} :catch_2c
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_12 .. :try_end_15} :catch_2c
    ...
    .catch Ljavax/xml/datatype/DatatypeConfigurationException; {:try_start_28 .. :try_end_2c} :catch_2c
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_28 .. :try_end_2c} :catch_2c
...
.method public notifyDeviceStateChangedIfNeeded()V
    ...
    move-result v4
    :try_end_29
    .catch Ljava/lang/IllegalStateException; {:try_start_1d .. :try_end_29} :catch_30
    .catchall {:try_start_1d .. :try_end_29} :catchall_44
    ...
    monitor-exit v0
    :try_end_3c
    .catchall {:try_start_30 .. :try_end_3c} :catchall_44
...
.method public setFoldStatePolicy(Lcom/android/server/policy/FoldStatePolicy;)V
    .registers 2

    .line 206
    iput-object p1, p0, Lcom/android/server/policy/DeviceStateProviderImpl;->mFoldStatePolicy:Lcom/android/server/policy/FoldStatePolicy;
