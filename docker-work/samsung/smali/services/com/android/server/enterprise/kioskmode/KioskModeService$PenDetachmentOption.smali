...
.method public static constructor <clinit>()V
    ...
    const-string v3, "ACTION_MEMO"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4, v4}, Lcom/android/server/enterprise/kioskmode/KioskModeService$PenDetachmentOption;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/android/server/enterprise/kioskmode/KioskModeService$PenDetachmentOption;->ACTION_MEMO:Lcom/android/server/enterprise/kioskmode/KioskModeService$PenDetachmentOption;

    new-instance v3, Lcom/android/server/enterprise/kioskmode/KioskModeService$PenDetachmentOption;

    const-string v5, "AIR_COMMAND"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6, v6}, Lcom/android/server/enterprise/kioskmode/KioskModeService$PenDetachmentOption;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/android/server/enterprise/kioskmode/KioskModeService$PenDetachmentOption;->AIR_COMMAND:Lcom/android/server/enterprise/kioskmode/KioskModeService$PenDetachmentOption;

    const/4 v5, 0x3

    new-array v5, v5, [Lcom/android/server/enterprise/kioskmode/KioskModeService$PenDetachmentOption;
    ...
    .line 2670
    sput-object v5, Lcom/android/server/enterprise/kioskmode/KioskModeService$PenDetachmentOption;->$VALUES:[Lcom/android/server/enterprise/kioskmode/KioskModeService$PenDetachmentOption;
...
.method public equals(I)Z
    ...
    .line 2680
    iget p0, p0, Lcom/android/server/enterprise/kioskmode/KioskModeService$PenDetachmentOption;->option:I
