...
.method public static parse(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/util/Date;
    ...
    if-eq v14, v11, :cond_c0

    if-eq v14, v10, :cond_c0
    ...
    if-le v15, v12, :cond_92

    const/16 v12, 0x3f

    if-ge v15, v12, :cond_92
    ...
    :cond_d9
    if-eq v14, v10, :cond_fa

    const/16 v10, 0x2d

    if-ne v14, v10, :cond_e0
    ...
    throw v0
    :try_end_1bc
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_6 .. :try_end_1bc} :catch_1bc
    .catch Ljava/lang/NumberFormatException; {:try_start_6 .. :try_end_1bc} :catch_1bc
    .catch Ljava/lang/IllegalArgumentException; {:try_start_6 .. :try_end_1bc} :catch_1bc
