...
# direct methods
.method public static synthetic $r8$lambda$c1sNTviMBVhCHFcCSI1sUpi_Ygk(Lcom/samsung/android/mcf/ble/BleAdvertiseData;Landroid/bluetooth/le/AdvertiseData$Builder;[B)V
    .registers 3

    invoke-direct {p0, p1, p2}, Lcom/samsung/android/mcf/ble/BleAdvertiseData;->lambda$toAdvertiseData$0(Landroid/bluetooth/le/AdvertiseData$Builder;[B)V

    return-void
.end method

.method public static synthetic $r8$lambda$muQZno1pySxsqE2-pafdimeNaIg(Lcom/samsung/android/mcf/ble/BleAdvertiseData;Landroid/bluetooth/le/AdvertiseData$Builder;[B)V
    .registers 3

    invoke-direct {p0, p1, p2}, Lcom/samsung/android/mcf/ble/BleAdvertiseData;->lambda$toAdvertiseData$1(Landroid/bluetooth/le/AdvertiseData$Builder;[B)V
...
.method private synthetic lambda$toAdvertiseData$0(Landroid/bluetooth/le/AdvertiseData$Builder;[B)V
    .registers 3

    iget-object p0, p0, Lcom/samsung/android/mcf/ble/BleAdvertiseData;->mServiceDataUuid:Landroid/os/ParcelUuid;

    invoke-virtual {p1, p0, p2}, Landroid/bluetooth/le/AdvertiseData$Builder;->addServiceData(Landroid/os/ParcelUuid;[B)Landroid/bluetooth/le/AdvertiseData$Builder;

    return-void
.end method

.method private synthetic lambda$toAdvertiseData$1(Landroid/bluetooth/le/AdvertiseData$Builder;[B)V
    .registers 3

    iget p0, p0, Lcom/samsung/android/mcf/ble/BleAdvertiseData;->mManufacturerId:I

    invoke-virtual {p1, p0, p2}, Landroid/bluetooth/le/AdvertiseData$Builder;->addManufacturerData(I[B)Landroid/bluetooth/le/AdvertiseData$Builder;
...
.method public getBundle(Landroid/os/Bundle;I)Landroid/os/Bundle;
    ...
    :cond_3e
    iget-boolean p0, p0, Lcom/samsung/android/mcf/ble/BleAdvertiseData;->mIncludeDeviceName:Z
...
.method public getManufacturerSpecificData()[B
    ...
    iget-object p0, p0, Lcom/samsung/android/mcf/ble/BleAdvertiseData;->mManufacturerSpecificData:[B
...
.method public getServiceData()[B
    ...
    iget-object p0, p0, Lcom/samsung/android/mcf/ble/BleAdvertiseData;->mServiceData:[B
...
.method public getServiceUuid()Landroid/os/ParcelUuid;
    ...
    iget-object p0, p0, Lcom/samsung/android/mcf/ble/BleAdvertiseData;->mServiceUuid:Landroid/os/ParcelUuid;
...
.method public hasResponseData()Z
    ...
    iget-boolean p0, p0, Lcom/samsung/android/mcf/ble/BleAdvertiseData;->mHasResponseData:Z
...
.method public toAdvertiseData()Landroid/bluetooth/le/AdvertiseData;
    ...
    invoke-virtual {v0, p0}, Landroid/bluetooth/le/AdvertiseData$Builder;->setIncludeDeviceName(Z)Landroid/bluetooth/le/AdvertiseData$Builder;
