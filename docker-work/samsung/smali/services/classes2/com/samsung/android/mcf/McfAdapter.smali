...
.field public final mMcfBleAdapters:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.field public final mMcfCasters:Ljava/util/concurrent/CopyOnWriteArraySet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/concurrent/CopyOnWriteArraySet<",
            "Ljava/lang/Integer;",
...
.field public final mMcfSubscribers:Ljava/util/concurrent/CopyOnWriteArraySet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/concurrent/CopyOnWriteArraySet<",
            "Ljava/lang/Integer;",
...
.method public static bindService(Landroid/content/Context;Lcom/samsung/android/mcf/McfAdapter$McfAdapterListener;)Z
    ...
    invoke-virtual {v0}, Lcom/samsung/android/mcf/McfAdapter;->bindService()Z
    ...
    :cond_3f
    :goto_3f
    const-string/jumbo p0, "this model does not support MCF. can\'t bind service"
...
.method public static getServiceVersionCode(Landroid/content/Context;)J
    ...
    :try_end_28
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_6 .. :try_end_28} :catch_29
...
.method public final bindService()Z
    ...
    iget-object p0, p0, Lcom/samsung/android/mcf/McfAdapter;->mEventListener:Lcom/samsung/android/mcf/McfContext$EventListener;

    invoke-virtual {v0, p0}, Lcom/samsung/android/mcf/McfContext;->a(Lcom/samsung/android/mcf/McfContext$EventListener;)Z
...
.method public closeBleAdapter(I)V
    ...
    iget-object p0, p0, Lcom/samsung/android/mcf/McfAdapter;->mContext:Lcom/samsung/android/mcf/McfContext;

    invoke-virtual {p0, p1}, Lcom/samsung/android/mcf/McfContext;->a(I)V
...
.method public closeCaster(I)V
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/mcf/McfContext;->b(I)V
...
.method public closeSubscriber(I)V
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/mcf/McfContext;->c(I)V
...
.method public getBleAdapter(ILcom/samsung/android/mcf/ble/BleAdapterCallback;)Lcom/samsung/android/mcf/McfBleAdapter;
    ...
    invoke-static {v3, v1, p0}, Lcom/samsung/android/mcf/common/DLog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/samsung/android/mcf/McfAdapter;->mMcfBleAdapters:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method public getCaster(ILcom/samsung/android/mcf/CasterCallback;)Lcom/samsung/android/mcf/McfCaster;
    ...
    iget-object p0, p0, Lcom/samsung/android/mcf/McfAdapter;->mMcfCasters:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    :cond_94
    :goto_94
    const-string p0, "Need BLUETOOTH_ADVERTISE, BLUETOOTH_SCAN, and BLUETOOTH_CONNECT permission"
...
.method public getService()Lcom/samsung/android/mcf/IMcfService;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/mcf/McfContext;->a()Lcom/samsung/android/mcf/IMcfService;
...
.method public getSubscriber(ILcom/samsung/android/mcf/SubscribeCallback;)Lcom/samsung/android/mcf/McfSubscriber;
    ...
    iget-object p0, p0, Lcom/samsung/android/mcf/McfAdapter;->mMcfSubscribers:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method public unbindService()Z
    ...
    invoke-virtual {v0, p0}, Lcom/samsung/android/mcf/McfContext;->b(Lcom/samsung/android/mcf/McfContext$EventListener;)V
