...
.method public constructor <init>(Landroid/content/Context;ILcom/samsung/android/mcf/SubscribeCallback;Lcom/samsung/android/mcf/IMcfService;Lcom/samsung/android/mcf/AbstractClient$StatusListener;)V
    ...
    .param p1    # Landroid/content/Context;
        ...
        .end annotation
    .end param
    .param p3    # Lcom/samsung/android/mcf/SubscribeCallback;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public a(ILcom/samsung/android/mcf/SubscribeCallback;)Z
    ...
    :cond_8
    iget-object p0, p0, Lcom/samsung/android/mcf/c;->j:Lcom/samsung/android/mcf/mcfwrapper/SubscriberCallbackWrapper;

    invoke-virtual {p0, p2}, Lcom/samsung/android/mcf/mcfwrapper/SubscriberCallbackWrapper;->isMyCallback(Lcom/samsung/android/mcf/SubscribeCallback;)Z
...
.method public closeMessagingClient(Lcom/samsung/android/mcf/messaging/McfMessageCallback;)Z
    ...
    const-string p1, "Ignore - not open"
...
.method public final f()V
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/mcf/mcfwrapper/SubscriberCallbackWrapper;->setMcfHandoverCallback(Lcom/samsung/android/mcf/handover/McfHandoverCallback;)V
...
.method public final g()V
    ...
    iget-object p0, p0, Lcom/samsung/android/mcf/c;->k:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public getMessagingDeviceRssi(JLcom/samsung/android/mcf/messaging/McfMessageCallback;)Z
    ...
    const-string/jumbo v2, "rssiInterval"
...
.method public final h()V
    ...
    :cond_1a
    iget-object p0, p0, Lcom/samsung/android/mcf/c;->l:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public keepDiscoveredDevice(Lcom/samsung/android/mcf/McfDevice;ZLcom/samsung/android/mcf/discovery/KeepDeviceCallback;)Z
    ...
    .param p1    # Lcom/samsung/android/mcf/McfDevice;
        ...
        .end annotation
    .end param
    .param p3    # Lcom/samsung/android/mcf/discovery/KeepDeviceCallback;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    const-string p1, "Ignore- already keep"
    ...
    const-string p1, "Ignore- not keep"
...
.method public openMessagingClient(Lcom/samsung/android/mcf/messaging/McfMessage;Lcom/samsung/android/mcf/messaging/McfMessageCallback;)Z
    ...
    const-string/jumbo v2, "openMessagingClient"
...
.method public registerHandoverCallback(Lcom/samsung/android/mcf/handover/McfHandoverCallback;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/mcf/mcfwrapper/SubscriberCallbackWrapper;->setMcfHandoverCallback(Lcom/samsung/android/mcf/handover/McfHandoverCallback;)V
...
.method public setTargetUwbParam(Lcom/samsung/android/mcf/ranging/McfUWBRangingCallback;Ljava/lang/String;[BI)Z
    ...
    const-string/jumbo v0, "setTargetUwbParam"
...
.method public startHandover(Lcom/samsung/android/mcf/handover/McfHandoverData;)Z
    ...
    const-string/jumbo p1, "startHandover"
...
.method public stopScanWithFlush(Lcom/samsung/android/mcf/discovery/McfDeviceDiscoverCallback;)I
    ...
    const-string/jumbo v1, "stopScanWithFlush"
