...
# direct methods
.method public static synthetic $r8$lambda$74TW_aLMfFvP_dKBIKpTVG6dG1c(Lcom/samsung/android/mcf/external/BluetoothCallHelper;ILcom/samsung/android/mcf/external/BluetoothCallHelper$DataReadyCallback;)V
    .registers 3

    invoke-direct {p0, p1, p2}, Lcom/samsung/android/mcf/external/BluetoothCallHelper;->lambda$updateDeviceList$0(ILcom/samsung/android/mcf/external/BluetoothCallHelper$DataReadyCallback;)V
...
.method public constructor <init>(Landroid/content/Context;ILcom/samsung/android/mcf/external/BluetoothCallHelper$DataReadyCallback;)V
    .registers 6
    .param p3    # Lcom/samsung/android/mcf/external/BluetoothCallHelper$DataReadyCallback;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    const-string p0, "BluetoothCallHelper"

    const-string p1, "checkBondedDeviceList"

    const-string p2, "Fail : can\'t access bluetooth Adapter"

    invoke-static {p0, p1, p2}, Lcom/samsung/android/mcf/common/DLog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_2f
    invoke-virtual {p0, p2, p3}, Lcom/samsung/android/mcf/external/BluetoothCallHelper;->updateDeviceList(ILcom/samsung/android/mcf/external/BluetoothCallHelper$DataReadyCallback;)V
    ...
    iget-object p0, p0, Lcom/samsung/android/mcf/external/BluetoothCallHelper;->mContext:Landroid/content/Context;
...
.method public static synthetic access$000(Lcom/samsung/android/mcf/external/BluetoothCallHelper;)V
    ...
    invoke-virtual {p0}, Lcom/samsung/android/mcf/external/BluetoothCallHelper;->updateBondedDeviceList()V
...
.method private synthetic lambda$updateDeviceList$0(ILcom/samsung/android/mcf/external/BluetoothCallHelper$DataReadyCallback;)V
    .registers 5
    ...
    const-string/jumbo v0, "updateDeviceList"
    ...
    invoke-virtual {p0}, Lcom/samsung/android/mcf/external/BluetoothCallHelper;->updateSyncedDeviceList()V

    goto :goto_23

    :cond_1e
    const-string p0, "To get synced device list , need BLUETOOTH_PRIVILEGED permission"

    invoke-static {v1, v0, p0}, Lcom/samsung/android/mcf/common/DLog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public getBluetoothDevice(Ljava/lang/String;)Landroid/bluetooth/BluetoothDevice;
    ...
    iget-object p0, p0, Lcom/samsung/android/mcf/external/BluetoothCallHelper;->mBondedCallDevice:Ljava/util/HashMap;

    invoke-virtual {p0, p1}, Ljava/util/HashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/samsung/android/mcf/external/BluetoothCallHelper$BluetoothCallDevice;

    invoke-virtual {p0}, Lcom/samsung/android/mcf/external/BluetoothCallHelper$BluetoothCallDevice;->getBluetoothDevice()Landroid/bluetooth/BluetoothDevice;
    ...
    iget-object p0, p0, Lcom/samsung/android/mcf/external/BluetoothCallHelper;->mSyncedCallDevice:Ljava/util/HashMap;
    ...
    :cond_38
    const-string p0, "can not found bluetooth Device"
...
.method public release()V
    ...
    iget-object p0, p0, Lcom/samsung/android/mcf/external/BluetoothCallHelper;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method public final updateBondedDeviceList()V
    .registers 7
    ...
    const-string/jumbo v1, "updateBondedDeviceList :"
...
.method public final updateDeviceList(ILcom/samsung/android/mcf/external/BluetoothCallHelper$DataReadyCallback;)V
    .registers 5
    .param p2    # Lcom/samsung/android/mcf/external/BluetoothCallHelper$DataReadyCallback;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public final updateSyncedDeviceList()V
    .registers 7
    ...
    const-string/jumbo v1, "updateSyncedDeviceList :"
