...
.field public static final DEBUG_KEY:Ljava/lang/String; = "MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEmJKs4lSn+XRhMQmMid+Zbhbu13YrU1haIhVC5296InRu1x7A8PV1ejQyisBODGgRY6pqkAHRncBCYcgg5wIIJg=="

.field public static final PROD_KEY:Ljava/lang/String; = "MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAE+lky6wKyGL6lE1VrD0YTMHwb0Xwc+tzC8MvnrzVxodvTpVY/jV7V+Zktcx+pry43XPABFRXtbhTo+qykhyBA1g=="

.field public static final TAG:Ljava/lang/String; = "SignedConfig"
...
.method public static createKey(Ljava/lang/String;)Ljava/security/PublicKey;
    ...
    :try_end_10
    .catch Ljava/lang/IllegalArgumentException; {:try_start_3 .. :try_end_10} :catch_22
    ...
    move-result-object p0
    :try_end_1a
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_10 .. :try_end_1a} :catch_1b
    .catch Ljava/security/spec/InvalidKeySpecException; {:try_start_10 .. :try_end_1a} :catch_1b
...
.method public verifySignature(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_end_b
    .catch Ljava/lang/IllegalArgumentException; {:try_start_3 .. :try_end_b} :catch_56
