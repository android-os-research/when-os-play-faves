...
.field public static final MSG_CLEANUP_USER:I = 0x8

.field public static final MSG_DISPATCH_UNLOCK_ATTEMPT:I = 0x3

.field public static final MSG_DISPATCH_UNLOCK_LOCKOUT:I = 0xd

.field public static final MSG_ENABLED_AGENTS_CHANGED:I = 0x4

.field public static final MSG_FLUSH_TRUST_USUALLY_MANAGED:I = 0xa

.field public static final MSG_KEYGUARD_SHOWING_CHANGED:I = 0x6

.field public static final MSG_REFRESH_DEVICE_LOCKED_FOR_USER:I = 0xe

.field public static final MSG_REFRESH_TRUSTABLE_TIMERS_AFTER_AUTH:I = 0x11

.field public static final MSG_REGISTER_LISTENER:I = 0x1

.field public static final MSG_SCHEDULE_TRUST_TIMEOUT:I = 0xf

.field public static final MSG_START_USER:I = 0x7

.field public static final MSG_STOP_USER:I = 0xc

.field public static final MSG_SWITCH_USER:I = 0x9

.field public static final MSG_UNLOCK_USER:I = 0xb

.field public static final MSG_UNREGISTER_LISTENER:I = 0x2

.field public static final MSG_USER_MAY_REQUEST_UNLOCK:I = 0x12

.field public static final MSG_USER_REQUESTED_UNLOCK:I = 0x10

.field public static final PERMISSION_PROVIDE_AGENT:Ljava/lang/String; = "android.permission.PROVIDE_TRUST_AGENT"

.field public static final PRIV_NAMESPACE:Ljava/lang/String; = "http://schemas.android.com/apk/prv/res/android"

.field public static final REFRESH_DEVICE_LOCKED_EXCEPT_USER:Ljava/lang/String; = "except"

.field public static final TAG:Ljava/lang/String; = "TrustManagerService"

.field public static final TRUSTABLE_IDLE_TIMEOUT_IN_MILLIS:J = 0x1b77400L

.field public static final TRUSTABLE_TIMEOUT_IN_MILLIS:J = 0x5265c00L

.field public static final TRUST_AGENT_INTENT:Landroid/content/Intent;

.field public static final TRUST_TIMEOUT_ALARM_TAG:Ljava/lang/String; = "TrustManagerService.trustTimeoutForUser"

.field public static final TRUST_TIMEOUT_IN_MILLIS:J = 0xdbba00L

.field public static final TRUST_USUALLY_MANAGED_FLUSH_DELAY:I = 0x1d4c0
...
.method public final getSettingsAttrs(Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)Lcom/android/server/trust/TrustManagerService$SettingsAttrs;
    ...
    move-result-object v1
    :try_end_16
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_10 .. :try_end_16} :catch_93
    .catch Ljava/io/IOException; {:try_start_10 .. :try_end_16} :catch_8d
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_10 .. :try_end_16} :catch_84
    .catchall {:try_start_10 .. :try_end_16} :catchall_7d
    ...
    :try_end_1d
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_18 .. :try_end_1d} :catch_7a
    .catch Ljava/io/IOException; {:try_start_18 .. :try_end_1d} :catch_77
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_18 .. :try_end_1d} :catch_74
    .catchall {:try_start_18 .. :try_end_1d} :catchall_71
    ...
    invoke-static {p0, p1}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_4c
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_23 .. :try_end_4c} :catch_7a
    .catch Ljava/io/IOException; {:try_start_23 .. :try_end_4c} :catch_77
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_23 .. :try_end_4c} :catch_74
    .catchall {:try_start_23 .. :try_end_4c} :catchall_71
    ...
    move-result-object v4
    :try_end_5a
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_50 .. :try_end_5a} :catch_7a
    .catch Ljava/io/IOException; {:try_start_50 .. :try_end_5a} :catch_77
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_50 .. :try_end_5a} :catch_74
    .catchall {:try_start_50 .. :try_end_5a} :catchall_71
    ...
    :try_end_66
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_5a .. :try_end_66} :catch_6f
    .catch Ljava/io/IOException; {:try_start_5a .. :try_end_66} :catch_6d
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_5a .. :try_end_66} :catch_6b
...
.method public refreshAgentList(I)V
    ...
    if-eq v10, v14, :cond_2da

    const/4 v14, 0x1

    if-ne v10, v14, :cond_2ad
...
.method public final refreshDeviceLockedForUser(II)V
    ...
    monitor-exit v3
    :try_end_a8
    .catchall {:try_start_a1 .. :try_end_a8} :catchall_c9
    ...
    monitor-exit v8
    :try_end_b2
    .catchall {:try_start_ab .. :try_end_b2} :catchall_c6
    ...
    move-result v8
    :try_end_b6
    .catch Landroid/os/RemoteException; {:try_start_b2 .. :try_end_b6} :catch_b7
...
.method public final setDeviceLockedForUser(IZ)V
    ...
    monitor-exit v0
    :try_end_13
    .catchall {:try_start_3 .. :try_end_13} :catchall_54
...
.method public final updateDualDARStateAndUnlockIfNeeded(I)V
    ...
    const-string/jumbo v0, "updateDualDARStateAndUnlockIfNeeded() - userId : "
...
.method public final updateTrustWithNonrenewableTrust(IIZ)V
    ...
    monitor-exit v3
    :try_end_9f
    .catchall {:try_start_2a .. :try_end_9f} :catchall_b5
...
.method public final updateTrustWithRenewableUnlock(IIZLcom/android/internal/infra/AndroidFuture;)V
    ...
    move-result v2
    :try_end_2a
    .catch Landroid/os/RemoteException; {:try_start_26 .. :try_end_2a} :catch_2c
    ...
    monitor-exit v5
    :try_end_83
    .catchall {:try_start_30 .. :try_end_83} :catchall_dc
    ...
    const-string/jumbo v5, "pendingTrustState: "
