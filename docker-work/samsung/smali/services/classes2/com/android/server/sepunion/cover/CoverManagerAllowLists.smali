.class public Lcom/android/server/sepunion/cover/CoverManagerAllowLists;
.super Ljava/lang/Object;
.source "CoverManagerAllowLists.java"


# static fields
.field public static final SIGNATURE_AMC_1:I = 0x400

.field public static final SIGNATURE_AMC_2:I = 0x800

.field public static final SIGNATURE_CHATONBLUE:I = 0x40

.field public static final SIGNATURE_COUNT:I = 0xe

.field public static final SIGNATURE_LGUUWA:I = 0x10

.field public static final SIGNATURE_MOBILEDESK:I = 0x20

.field public static final SIGNATURE_MSC:I = 0x8

.field public static final SIGNATURE_SAMSUNG_APPLICATION:I = 0x2

.field public static final SIGNATURE_SAMSUNG_PLATFORM:I = 0x1

.field public static final SIGNATURE_SAMSUNG_SHARED:I = 0x4

.field public static final SIGNATURE_SDS:I = 0x1000

.field public static final SIGNATURE_SHEALTH:I = 0x200

.field public static final SIGNATURE_SKT:I = 0x2000

.field public static final SIGNATURE_SOUNDPHONE:I = 0x100

.field public static final SIGNATURE_WHOWHO:I = 0x80
...
# virtual methods
.method public final convertPackageName(Ljava/lang/String;)Ljava/lang/String;
    .registers 4
    ...
    move-result v1
    :try_end_1c
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_1c} :catch_1f
...
.method public final ensureUserContext(Landroid/content/Context;Landroid/os/UserHandle;)Landroid/content/Context;
    ...
    invoke-virtual {p1, p0, v0, p2}, Landroid/content/Context;->createPackageContextAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)Landroid/content/Context;
    ...
    invoke-static {p2, v0, p0}, Lcom/samsung/android/sepunion/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    :goto_12
    return-object p1
.end method

.method public getPackageForPid(Landroid/content/Context;I)Ljava/lang/String;
    .registers 4
...
.method public final hasSamsungKey([Landroid/content/pm/Signature;)Z
    .registers 3
...
.method public isAllowedToUse(Landroid/content/Context;II)Z
    ...
    .line 155
    invoke-virtual {p0, p1, v5}, Lcom/android/server/sepunion/cover/CoverManagerAllowLists;->ensureUserContext(Landroid/content/Context;Landroid/os/UserHandle;)Landroid/content/Context;
    ...
    invoke-virtual {p1, p3, v5}, Landroid/content/pm/PackageManager;->getPackageUidAsUser(Ljava/lang/String;I)I

    move-result v4
    :try_end_32
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_20 .. :try_end_32} :catch_33
    ...
    invoke-static {p1, v5}, Lcom/samsung/android/sepunion/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string p2, "isAllowedToUse : pkg does not match uid"
    ...
    const-string p2, "isAllowedToUse : pkgInfo is null"
    ...
    .line 192
    invoke-virtual {p0, p2}, Lcom/android/server/sepunion/cover/CoverManagerAllowLists;->hasSamsungKey([Landroid/content/pm/Signature;)Z
    ...
    const-string v0, "isAllowedToUse : cover manager allow lists does not include this App : "
    ...
    invoke-virtual {p0, p2, p1}, Lcom/android/server/sepunion/cover/CoverManagerAllowLists;->isMatchedSignature([Landroid/content/pm/Signature;I)Z
...
.method public final setupAllowList()V
    ...
    const-string v2, "Y29tLnNhbXN1bmcucmFkaW8="
    ...
    const-string v2, "Y29tLnVwbHVzLmlwYWdlbnQ="
    ...
    const-string v2, "Y29tLnNkcy5tb2JpbGVkZXNr"
    ...
    const-string v2, "Y29tLnNlYy5jaGF0b25ibHVl"
    ...
    const-string v2, "Y29tLmt0Y3Mud2hvd2hv"
    ...
    const-string v2, "Y29tLnNlYy5zYW1zdW5nc291bmRwaG9uZQ=="
    ...
    const-string v2, "Y29tLnNlYy5hbmRyb2lkLmFwcC5zaGVhbHRo"
    ...
    const-string v2, "Y29tLmFtYy51aQ=="
    ...
    const-string v2, "Y29tLnNkcy5tbXMudWk="
