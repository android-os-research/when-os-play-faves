...
# static fields
.field public static final TAG:Ljava/lang/String; = "BLASTSyncEngine"
...
.method public startSyncSet(Lcom/android/server/wm/BLASTSyncEngine$TransactionReadyListener;)I
    .registers 5
    ...
    .line 295
    invoke-virtual {p0, p1, v0, v1, v2}, Lcom/android/server/wm/BLASTSyncEngine;->startSyncSet(Lcom/android/server/wm/BLASTSyncEngine$TransactionReadyListener;JLjava/lang/String;)I
...
.method public startSyncSet(Lcom/android/server/wm/BLASTSyncEngine$SyncGroup;J)V
    ...
    const-string v3, "SyncGroup %d: Started when there is other active SyncGroup"

    invoke-static {v0, v5, v2, v3, v6}, Lcom/android/internal/protolog/ProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v0, "SyncGroup %d: Started for listener: %s"

    invoke-static {v5, v6, v2, v0, v7}, Lcom/android/internal/protolog/ProtoLogImpl;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
