...
.field public static final TIMEOUT_MS:J = 0x2710L


# instance fields
.field public mCanceled:Z

.field public final mClosingSplitTasks:Landroid/util/SparseArray;
...
.field public mIsOpeningHomeTask:Z
...
.field public mStageRootRemoteRecord:Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationRecord;
...
.method public constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/DisplayContent;Landroid/view/RemoteAnimationAdapter;Landroid/os/Handler;)V
    ...
    .line 83
    new-instance v0, Lcom/android/server/wm/RemoteAnimationController$$ExternalSyntheticLambda2;

    invoke-direct {v0, p0}, Lcom/android/server/wm/RemoteAnimationController$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/wm/RemoteAnimationController;)V
    ...
    iput-object v0, p0, Lcom/android/server/wm/RemoteAnimationController;->mClosingSplitTasks:Landroid/util/SparseArray;

    const/4 v0, 0x0

    .line 94
    iput-object v0, p0, Lcom/android/server/wm/RemoteAnimationController;->mStageRootRemoteRecord:Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationRecord;

    const/4 v0, 0x0

    .line 95
    iput-boolean v0, p0, Lcom/android/server/wm/RemoteAnimationController;->mIsOpeningHomeTask:Z
...
.method private synthetic lambda$goodToGo$1(I[Landroid/view/RemoteAnimationTarget;[Landroid/view/RemoteAnimationTarget;[Landroid/view/RemoteAnimationTarget;)V
    ...
    .line 228
    iget-object v0, v1, Lcom/android/server/wm/RemoteAnimationController;->mHandler:Landroid/os/Handler;

    iget-object v3, v1, Lcom/android/server/wm/RemoteAnimationController;->mTimeoutRunnable:Ljava/lang/Runnable;

    const v4, 0x461c4000    # 10000.0f

    iget-object v5, v1, Lcom/android/server/wm/RemoteAnimationController;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    sget-object v13, Lcom/android/internal/protolog/ProtoLogGroup;->WM_FORCE_DEBUG_REMOTE_ANIMATIONS:Lcom/android/internal/protolog/ProtoLogGroup;

    const-string v14, "goodToGo(%s): onAnimationStart, transit=%s, apps=%d, wallpapers=%d, nonApps=%d"
    ...
    invoke-static {v13, v0, v3, v14, v15}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string/jumbo v5, "startAnimation(): Notify animation start:"

    invoke-static {v0, v3, v2, v5, v4}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method public cancelAnimation(Ljava/lang/String;)V
    ...
    sget-object v3, Lcom/android/internal/protolog/ProtoLogGroup;->WM_FORCE_DEBUG_REMOTE_ANIMATIONS:Lcom/android/internal/protolog/ProtoLogGroup;

    const v4, 0xe08e1bd

    const-string v5, "cancelAnimation(%s): reason=%s"
...
.method public final createAppAnimations()[Landroid/view/RemoteAnimationTarget;
    ...
    invoke-static {v0, v2, v1, v4, v3}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 294
    invoke-virtual {p0}, Lcom/android/server/wm/RemoteAnimationController;->isExitingSplitScreenByHome()Z

    move-result v5

    if-eqz v5, :cond_3b

    iget-object v5, p0, Lcom/android/server/wm/RemoteAnimationController;->mStageRootRemoteRecord:Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationRecord;
    ...
    const-string v4, "\tAdd container=%s"
    ...
    const-string v5, "\tRemove container=%s"

    invoke-static {v6, v7, v1, v5, v8}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v4, v4, Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationRecord;->mThumbnailAdapter:Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationAdapterWrapper;
...
.method public final createNonAppWindowAnimations(I)[Landroid/view/RemoteAnimationTarget;
    ...
    const-string v4, "createNonAppWindowAnimations()"
...
.method public createRemoteAnimationRecord(Lcom/android/server/wm/WindowContainer;Landroid/graphics/Point;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationRecord;
    ...
    const-string v0, "createAnimationAdapter(): container=%s"
    ...
    .line 120
    :cond_18
    new-instance v7, Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationRecord;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationRecord;-><init>(Lcom/android/server/wm/RemoteAnimationController;Lcom/android/server/wm/WindowContainer;Landroid/graphics/Point;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    .line 124
    sget-boolean v0, Lcom/samsung/android/rune/CoreRune;->FW_REVERSE_REMOTE_ANIMATION:Z

    if-eqz v0, :cond_2e

    .line 125
    iget-object v0, v7, Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationRecord;->mAdapter:Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationAdapterWrapper;
    ...
    .line 135
    iput-object v7, p0, Lcom/android/server/wm/RemoteAnimationController;->mStageRootRemoteRecord:Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationRecord;
...
.method public final createWallpaperAnimations()[Landroid/view/RemoteAnimationTarget;
    ...
    new-instance v10, Lcom/android/server/wm/RemoteAnimationController$$ExternalSyntheticLambda0;

    invoke-direct {v10, p0}, Lcom/android/server/wm/RemoteAnimationController$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/wm/RemoteAnimationController;)V
...
.method public goodToGo(I)V
    ...
    const-string p1, "goodToGo(%s): Animation canceled already"

    invoke-static {v0, v3, v2, p1, v1}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/RemoteAnimationController;->mStageRootRemoteRecord:Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationRecord;
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/TaskOrganizerController;->notifySplitExitRemoteAnimationStarted()V
    ...
    invoke-static {p1, v0, v1, v2, v5}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    new-instance v2, Lcom/android/server/wm/RemoteAnimationController$$ExternalSyntheticLambda1;
...
.method public final invokeAnimationCancelled(Ljava/lang/String;)V
    ...
    const-string p1, "cancelAnimation(): reason=%s"

    invoke-static {v0, v1, v3, p1, v2}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
...
.method public isExitingSplitScreenByHome()Z
    .registers 2

    .line 627
    iget-boolean v0, p0, Lcom/android/server/wm/RemoteAnimationController;->mIsOpeningHomeTask:Z

    if-eqz v0, :cond_f

    iget-object p0, p0, Lcom/android/server/wm/RemoteAnimationController;->mClosingSplitTasks:Landroid/util/SparseArray;
...
.method public final onAnimationFinished()V
    ...
    sget-object v7, Lcom/android/internal/protolog/ProtoLogGroup;->WM_FORCE_DEBUG_REMOTE_ANIMATIONS:Lcom/android/internal/protolog/ProtoLogGroup;

    const v8, 0x3711a6aa

    const/4 v9, 0x4

    const-string/jumbo v10, "onAnimationFinished(%s): mPendingAnimations=%d, caller=%s"
    ...
    invoke-static {v7, v8, v9, v10, v6}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v3, p0, Lcom/android/server/wm/RemoteAnimationController;->mStageRootRemoteRecord:Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationRecord;
    ...
    invoke-virtual {v3}, Lcom/android/server/wm/TaskOrganizerController;->notifySplitExitRemoteAnimationFinished()V

    .line 372
    :cond_5c
    iget-object v3, p0, Lcom/android/server/wm/RemoteAnimationController;->mClosingSplitTasks:Landroid/util/SparseArray;
    ...
    .line 373
    iput-object v3, p0, Lcom/android/server/wm/RemoteAnimationController;->mStageRootRemoteRecord:Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationRecord;

    .line 374
    iput-boolean v2, p0, Lcom/android/server/wm/RemoteAnimationController;->mIsOpeningHomeTask:Z
    ...
    :try_end_71
    .catchall {:try_start_46 .. :try_end_71} :catchall_1bc
    ...
    const-string/jumbo v6, "onAnimationFinished(): Notify animation finished:"

    invoke-static {v4, v5, v2, v6, v3}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v6, v7, v2, v8, v9}, Lcom/android/internal/protolog/ProtoLogImpl;->d(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    :try_end_17f
    .catch Ljava/lang/Exception; {:try_start_71 .. :try_end_17f} :catch_1ab
    .catchall {:try_start_71 .. :try_end_17f} :catchall_1a9
    ...
    invoke-virtual {v1, v4}, Lcom/android/server/wm/WindowManagerService;->closeSurfaceTransaction(Ljava/lang/String;)V

    .line 432
    monitor-exit v0
    :try_end_18a
    .catchall {:try_start_182 .. :try_end_18a} :catchall_1bc
    ...
    invoke-direct {v0}, Lcom/android/server/wm/RemoteAnimationController$$ExternalSyntheticLambda3;-><init>()V

    .line 436
    iget-object v1, p0, Lcom/android/server/wm/RemoteAnimationController;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
    ...
    invoke-static {p0, v0, v2, v1, v3}, Lcom/android/internal/protolog/ProtoLogImpl;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    throw v1
    :try_end_1b4
    .catchall {:try_start_1ac .. :try_end_1b4} :catchall_1a9
    ...
    monitor-exit v0
    :try_end_1be
    .catchall {:try_start_1b4 .. :try_end_1be} :catchall_1bc
...
.method public updateExitSplitScreenByHome()V
    .registers 7
    ...
    .line 604
    iget-object v1, p0, Lcom/android/server/wm/RemoteAnimationController;->mClosingSplitTasks:Landroid/util/SparseArray;
    ...
    .line 611
    iget-object v3, v2, Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationRecord;->mWindowContainer:Lcom/android/server/wm/WindowContainer;
    ...
    .line 612
    invoke-virtual {v2}, Lcom/android/server/wm/RemoteAnimationController$RemoteAnimationRecord;->getMode()I
    ...
    .line 617
    :goto_3f
    iput-boolean v5, p0, Lcom/android/server/wm/RemoteAnimationController;->mIsOpeningHomeTask:Z
    ...
    .line 621
    iget-object v2, p0, Lcom/android/server/wm/RemoteAnimationController;->mClosingSplitTasks:Landroid/util/SparseArray;
...
.method public final writeStartDebugStatement()V
    ...
    invoke-static {v0, v2, v1, v4, v3}, Lcom/android/internal/protolog/ProtoLogImpl;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v0, v2, v1, p0, v3}, Lcom/android/internal/protolog/ProtoLogImpl;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
