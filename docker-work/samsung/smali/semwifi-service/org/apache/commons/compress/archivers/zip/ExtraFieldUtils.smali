...
.method public static parse([BZLorg/apache/commons/compress/archivers/zip/ExtraFieldUtils$UnparseableExtraField;)[Lorg/apache/commons/compress/archivers/zip/ZipExtraField;
    ...
    :try_end_94
    .catch Ljava/lang/InstantiationException; {:try_start_90 .. :try_end_94} :catch_cb
    .catch Ljava/lang/IllegalAccessException; {:try_start_90 .. :try_end_94} :catch_cb

    if-eqz p1, :cond_9a

    .line 180
    :try_start_96
    invoke-interface {v5, p0, v4, v3}, Lorg/apache/commons/compress/archivers/zip/ZipExtraField;->parseFromLocalFileData([BII)V

    goto :goto_9d

    .line 182
    :cond_9a
    invoke-interface {v5, p0, v4, v3}, Lorg/apache/commons/compress/archivers/zip/ZipExtraField;->parseFromCentralDirectoryData([BII)V
    :try_end_9d
    .catch Ljava/lang/ArrayIndexOutOfBoundsException; {:try_start_96 .. :try_end_9d} :catch_a5
    .catch Ljava/lang/InstantiationException; {:try_start_96 .. :try_end_9d} :catch_cb
    .catch Ljava/lang/IllegalAccessException; {:try_start_96 .. :try_end_9d} :catch_cb
    ...
    throw p0
    :try_end_cb
    .catch Ljava/lang/InstantiationException; {:try_start_9d .. :try_end_cb} :catch_cb
    .catch Ljava/lang/IllegalAccessException; {:try_start_9d .. :try_end_cb} :catch_cb
