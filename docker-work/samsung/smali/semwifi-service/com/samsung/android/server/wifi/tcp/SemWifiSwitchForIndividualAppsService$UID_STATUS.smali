...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/samsung/android/server/wifi/tcp/SemWifiSwitchForIndividualAppsService$UID_STATUS;

    const-string v3, "DETECTED"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/samsung/android/server/wifi/tcp/SemWifiSwitchForIndividualAppsService$UID_STATUS;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/samsung/android/server/wifi/tcp/SemWifiSwitchForIndividualAppsService$UID_STATUS;->DETECTED:Lcom/samsung/android/server/wifi/tcp/SemWifiSwitchForIndividualAppsService$UID_STATUS;

    new-instance v3, Lcom/samsung/android/server/wifi/tcp/SemWifiSwitchForIndividualAppsService$UID_STATUS;

    const-string v5, "ACTIVATED"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/samsung/android/server/wifi/tcp/SemWifiSwitchForIndividualAppsService$UID_STATUS;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/samsung/android/server/wifi/tcp/SemWifiSwitchForIndividualAppsService$UID_STATUS;->ACTIVATED:Lcom/samsung/android/server/wifi/tcp/SemWifiSwitchForIndividualAppsService$UID_STATUS;

    new-instance v5, Lcom/samsung/android/server/wifi/tcp/SemWifiSwitchForIndividualAppsService$UID_STATUS;

    const-string v7, "REMOVED"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/samsung/android/server/wifi/tcp/SemWifiSwitchForIndividualAppsService$UID_STATUS;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/samsung/android/server/wifi/tcp/SemWifiSwitchForIndividualAppsService$UID_STATUS;->REMOVED:Lcom/samsung/android/server/wifi/tcp/SemWifiSwitchForIndividualAppsService$UID_STATUS;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/samsung/android/server/wifi/tcp/SemWifiSwitchForIndividualAppsService$UID_STATUS;
    ...
    .line 319
    sput-object v7, Lcom/samsung/android/server/wifi/tcp/SemWifiSwitchForIndividualAppsService$UID_STATUS;->$VALUES:[Lcom/samsung/android/server/wifi/tcp/SemWifiSwitchForIndividualAppsService$UID_STATUS;
