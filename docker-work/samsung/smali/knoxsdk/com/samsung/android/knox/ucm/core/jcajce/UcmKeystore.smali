...
# virtual methods
.method public final whitelist test-api engineAliases()Ljava/util/Enumeration;
    .registers 5
...
.method public final whitelist test-api engineContainsAlias(Ljava/lang/String;)Z
    .registers 7
...
.method public final whitelist test-api engineDeleteEntry(Ljava/lang/String;)V
    .registers 4
...
.method public final whitelist test-api engineGetCertificate(Ljava/lang/String;)Ljava/security/cert/Certificate;
    .registers 4
...
.method public final whitelist test-api engineGetCertificateAlias(Ljava/security/cert/Certificate;)Ljava/lang/String;
    .registers 2
...
.method public final whitelist test-api engineGetCertificateChain(Ljava/lang/String;)[Ljava/security/cert/Certificate;
    .registers 4
    ...
    :try_end_68
    .catch Ljava/security/cert/CertificateException; {:try_start_4b .. :try_end_68} :catch_69
...
.method public final whitelist test-api engineGetCreationDate(Ljava/lang/String;)Ljava/util/Date;
    .registers 3
...
.method public final whitelist test-api engineGetKey(Ljava/lang/String;[C)Ljava/security/Key;
    .registers 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public final whitelist test-api engineIsCertificateEntry(Ljava/lang/String;)Z
    .registers 3
...
.method public final whitelist test-api engineIsKeyEntry(Ljava/lang/String;)Z
    .registers 4
...
.method public final whitelist test-api engineLoad(Ljava/io/InputStream;[C)V
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public final whitelist test-api engineSetCertificateEntry(Ljava/lang/String;Ljava/security/cert/Certificate;)V
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/KeyStoreException;
...
.method public final whitelist test-api engineSetEntry(Ljava/lang/String;Ljava/security/KeyStore$Entry;Ljava/security/KeyStore$ProtectionParameter;)V
    .registers 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/KeyStoreException;
...
.method public final whitelist test-api engineSetKeyEntry(Ljava/lang/String;Ljava/security/Key;[C[Ljava/security/cert/Certificate;)V
    .registers 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/KeyStoreException;
    ...
    .line 14
    invoke-virtual {p0, p1, v0, p4, v1}, Lcom/samsung/android/knox/ucm/core/jcajce/UcmKeystore;->importKeyPair(Ljava/lang/String;[B[Ljava/security/cert/Certificate;Ljava/lang/String;)V
...
.method public final whitelist test-api engineSetKeyEntry(Ljava/lang/String;[B[Ljava/security/cert/Certificate;)V
    .registers 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/KeyStoreException;
...
.method public final whitelist test-api engineSize()I
    .registers 3
...
.method public final whitelist test-api engineStore(Ljava/io/OutputStream;[C)V
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
...
.method public final greylist importKeyPair(Ljava/lang/String;[B[Ljava/security/cert/Certificate;Ljava/lang/String;)V
    ...
    :try_end_1e
    .catch Ljava/io/IOException; {:try_start_17 .. :try_end_1e} :catch_24
    .catch Ljava/security/cert/CertificateEncodingException; {:try_start_17 .. :try_end_1e} :catch_1f
