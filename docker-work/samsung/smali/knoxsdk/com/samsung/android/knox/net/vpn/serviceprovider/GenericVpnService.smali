...
.method public static greylist checkIfAdminHasVpnPermission()Z
    ...
    .line 12
    invoke-interface {v2, v1, v3}, Landroid/content/pm/IPackageManager;->checkUidPermission(Ljava/lang/String;I)I
    ...
    move-result v2
    :try_end_10
    .catch Landroid/os/RemoteException; {:try_start_4 .. :try_end_10} :catch_14
    ...
    .line 27
    invoke-static {v2, v3, v0}, Lcom/samsung/android/knox/ContextInfo$$ExternalSyntheticOutline0;->m$1(Landroid/os/RemoteException;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method public static greylist prepare(Landroid/content/Context;Ljava/lang/String;ZZ)Landroid/content/Intent;
    ...
    .line 86
    const-string p1, "Exception in prepare : "
...
# virtual methods
.method public final greylist addAddress(Ljava/net/InetAddress;I)Z
    .registers 4
...
.method public final greylist onRevoke()V
    .registers 1
...
.method public final greylist protect(I)Z
    .registers 3
    ...
    const-string v0, "GenericVpnService.protect"
    ...
    invoke-interface {p0, v0}, Landroid/net/IVpnManager;->getChainingEnabledForProfile(I)Z
    ...
    :cond_2a
    const-string p0, "GenericVpnService"
    ...
    const-string v0, "protect is not going to be called for "
...
.method public final greylist protect(Ljava/net/DatagramSocket;)Z
    .registers 2
...
.method public final greylist protect(Ljava/net/Socket;)Z
    .registers 2
...
.method public final greylist removeAddress(Ljava/net/InetAddress;I)Z
    .registers 4
