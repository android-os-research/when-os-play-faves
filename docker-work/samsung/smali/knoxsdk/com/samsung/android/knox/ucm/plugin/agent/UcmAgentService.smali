...
# direct methods
.method public static bridge synthetic greylist -$$Nest$mdecrypt(Lcom/samsung/android/knox/ucm/plugin/agent/UcmAgentService;Ljava/lang/String;[BLjava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    .registers 5
...
.method public static bridge synthetic greylist -$$Nest$mencrypt(Lcom/samsung/android/knox/ucm/plugin/agent/UcmAgentService;Ljava/lang/String;[BLjava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    .registers 5
...
.method public static bridge synthetic greylist -$$Nest$msign(Lcom/samsung/android/knox/ucm/plugin/agent/UcmAgentService;Ljava/lang/String;[BLjava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    .registers 5
...
.method private final greylist decrypt(Ljava/lang/String;[BLjava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 76
    .line 77
    invoke-static {v4}, Lcom/samsung/android/knox/ContextInfo$$ExternalSyntheticOutline0;->m(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    .line 135
    invoke-virtual {v5, p1, v6}, Lcom/samsung/android/knox/ucm/plugin/service/KeyStore;->getEntry(Ljava/lang/String;Ljava/security/KeyStore$ProtectionParameter;)Ljava/security/KeyStore$Entry;
    ...
    .line 172
    .line 173
    invoke-static {p3, v7}, Lcom/samsung/android/knox/ucm/plugin/service/Cipher;->getInstance(Ljava/lang/String;Ljava/security/Provider;)Lcom/samsung/android/knox/ucm/plugin/service/Cipher;
    ...
    .line 177
    invoke-virtual {v7, p4}, Lcom/samsung/android/knox/ucm/plugin/service/Cipher;->setProperty(Landroid/os/Bundle;)V
    ...
    .line 319
    :goto_13f
    invoke-virtual {v7, v0, p1, p3}, Lcom/samsung/android/knox/ucm/plugin/service/Cipher;->init(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    .line 338
    invoke-virtual {v7, p0}, Lcom/samsung/android/knox/ucm/plugin/service/Cipher;->updateAAD([B)V
    ...
    .line 376
    invoke-virtual {v7, p0, p1}, Lcom/samsung/android/knox/ucm/plugin/service/Cipher;->init(ILjava/security/Key;)V
    ...
    :try_end_189
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_61 .. :try_end_189} :catch_203
    .catch Ljava/security/InvalidKeyException; {:try_start_61 .. :try_end_189} :catch_1f9
    .catch Ljava/security/UnrecoverableEntryException; {:try_start_61 .. :try_end_189} :catch_1ef
    .catch Ljava/security/KeyStoreException; {:try_start_61 .. :try_end_189} :catch_1e5
    .catch Ljava/security/cert/CertificateException; {:try_start_61 .. :try_end_189} :catch_1db
    .catch Ljava/io/IOException; {:try_start_61 .. :try_end_189} :catch_1d1
    .catch Ljavax/crypto/BadPaddingException; {:try_start_61 .. :try_end_189} :catch_1c7
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_61 .. :try_end_189} :catch_1bd
    .catch Ljava/lang/IllegalArgumentException; {:try_start_61 .. :try_end_189} :catch_1b3
    .catch Ljava/lang/NullPointerException; {:try_start_61 .. :try_end_189} :catch_1aa
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_61 .. :try_end_189} :catch_1a0
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_61 .. :try_end_189} :catch_196
    .catch Ljava/lang/IllegalStateException; {:try_start_61 .. :try_end_189} :catch_18a
...
.method private final greylist deleteKey(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    :try_end_98
    .catch Ljava/security/KeyStoreException; {:try_start_4d .. :try_end_98} :catch_ce
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_4d .. :try_end_98} :catch_c6
    .catch Ljava/io/IOException; {:try_start_4d .. :try_end_98} :catch_bc
    .catch Ljava/security/cert/CertificateException; {:try_start_4d .. :try_end_98} :catch_b4
    .catch Ljava/lang/IllegalArgumentException; {:try_start_4d .. :try_end_98} :catch_aa
    .catch Ljava/lang/NullPointerException; {:try_start_4d .. :try_end_98} :catch_a2
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_4d .. :try_end_98} :catch_99
...
.method private final greylist encrypt(Ljava/lang/String;[BLjava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 4
    invoke-direct {p0, v3}, Lcom/samsung/android/knox/ucm/plugin/agent/UcmAgentService;->responseErrorWithNullBytes(I)Landroid/os/Bundle;
    ...
    invoke-virtual {v3, v1, p0}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V
    :try_end_148
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_69 .. :try_end_148} :catch_1aa
    .catch Ljava/security/InvalidKeyException; {:try_start_69 .. :try_end_148} :catch_1a0
    .catch Ljava/security/UnrecoverableEntryException; {:try_start_69 .. :try_end_148} :catch_196
    .catch Ljava/security/KeyStoreException; {:try_start_69 .. :try_end_148} :catch_18c
    .catch Ljava/security/cert/CertificateException; {:try_start_69 .. :try_end_148} :catch_182
    .catch Ljava/io/IOException; {:try_start_69 .. :try_end_148} :catch_178
    .catch Ljavax/crypto/BadPaddingException; {:try_start_69 .. :try_end_148} :catch_16e
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_69 .. :try_end_148} :catch_164
    .catch Ljava/lang/IllegalArgumentException; {:try_start_69 .. :try_end_148} :catch_15a
    .catch Ljava/lang/NullPointerException; {:try_start_69 .. :try_end_148} :catch_152
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_69 .. :try_end_148} :catch_149
...
.method private final greylist generateKey(Lcom/samsung/android/knox/ucm/plugin/keystore/KeyGenParameterSpec;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 29
    iget-object v4, p1, Lcom/samsung/android/knox/ucm/plugin/keystore/KeyGenParameterSpec;->mKeystoreAlias:Ljava/lang/String;
    ...
    .line 75
    :try_start_4b
    iget-object v7, p1, Lcom/samsung/android/knox/ucm/plugin/keystore/KeyGenParameterSpec;->mAlgorithm:Ljava/lang/String;
    ...
    .line 78
    .line 79
    invoke-static {v7, p0}, Lcom/samsung/android/knox/ucm/plugin/service/KeyGenerator;->getInstance(Ljava/lang/String;Ljava/security/Provider;)Lcom/samsung/android/knox/ucm/plugin/service/KeyGenerator;
    ...
    .line 85
    .line 86
    invoke-virtual {p0, p1, v4}, Lcom/samsung/android/knox/ucm/plugin/service/KeyGenerator;->init(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    .line 105
    .line 106
    const-string p2, "UCMERRORTESTING: @UcmAgentService responding to generateKey : "
    ...
    invoke-static {v2, p0}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_79
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_4b .. :try_end_79} :catch_8c
    .catch Ljava/lang/NullPointerException; {:try_start_4b .. :try_end_79} :catch_84
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_4b .. :try_end_79} :catch_7a
...
.method private final greylist generateKeyPair(Ljava/lang/String;Ljava/lang/String;ILandroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 129
    .line 130
    invoke-static {v6}, Lcom/samsung/android/knox/ContextInfo$$ExternalSyntheticOutline0;->m(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :try_end_e0
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_ae .. :try_end_e0} :catch_104
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_ae .. :try_end_e0} :catch_fc
    .catch Ljava/lang/IllegalArgumentException; {:try_start_ae .. :try_end_e0} :catch_f2
    .catch Ljava/lang/NullPointerException; {:try_start_ae .. :try_end_e0} :catch_ea
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_ae .. :try_end_e0} :catch_e1
...
.method private final greylist generateSecureRandom(ILandroid/os/Bundle;)Landroid/os/Bundle;
    ...
    :try_end_66
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_4d .. :try_end_66} :catch_82
    .catch Ljava/lang/IllegalArgumentException; {:try_start_4d .. :try_end_66} :catch_78
    .catch Ljava/lang/NullPointerException; {:try_start_4d .. :try_end_66} :catch_70
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_4d .. :try_end_66} :catch_67
...
.method private final greylist getCertificateChain(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    move-result-object p0
    :try_end_ad
    .catch Ljava/security/KeyStoreException; {:try_start_4d .. :try_end_ad} :catch_ef
    .catch Ljava/security/cert/CertificateEncodingException; {:try_start_4d .. :try_end_ad} :catch_e5
    .catch Ljava/security/cert/CertificateException; {:try_start_4d .. :try_end_ad} :catch_db
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_4d .. :try_end_ad} :catch_d3
    .catch Ljava/io/IOException; {:try_start_4d .. :try_end_ad} :catch_c9
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_4d .. :try_end_ad} :catch_c0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_4d .. :try_end_ad} :catch_b6
    .catch Ljava/lang/NullPointerException; {:try_start_4d .. :try_end_ad} :catch_ae
...
.method private final greylist getKeyType(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 163
    invoke-virtual {v1, v3, v11}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V
    ...
    :try_end_df
    .catch Ljava/security/KeyStoreException; {:try_start_87 .. :try_end_df} :catch_107
    .catch Ljava/security/cert/CertificateException; {:try_start_87 .. :try_end_df} :catch_fd
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_87 .. :try_end_df} :catch_f4
    .catch Ljava/io/IOException; {:try_start_87 .. :try_end_df} :catch_ea
    .catch Ljava/security/UnrecoverableKeyException; {:try_start_87 .. :try_end_df} :catch_e0
    ...
    .line 276
    :cond_114
    const-string p0, "UCMERRORTESTING: @UcmAgentService responding to getKeyType with EXCEPTION error code  = "
...
.method private final greylist importKey(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 65
    .line 66
    sget-object v8, Lcom/samsung/android/knox/ucm/plugin/agent/UcmAgentProviderImpl;->KEY_EXTRA_BLOCK_MODES:Ljava/lang/String;
    ...
    .line 86
    .line 87
    sget-object v8, Lcom/samsung/android/knox/ucm/plugin/agent/UcmAgentProviderImpl;->KEY_EXTRA_SIGNATURE_PADDINGS:Ljava/lang/String;
    ...
    .line 104
    invoke-virtual {v4, v5}, Landroid/security/keystore/KeyProtection$Builder;->setRandomizedEncryptionRequired(Z)Landroid/security/keystore/KeyProtection$Builder;
    ...
    .line 203
    .line 204
    invoke-virtual {p0, p1, p2, v4}, Lcom/samsung/android/knox/ucm/plugin/service/KeyStore;->setEntry(Ljava/lang/String;Ljava/security/KeyStore$Entry;Ljava/security/KeyStore$ProtectionParameter;)V
    ...
    .line 221
    .line 222
    const-string p2, "UCMERRORTESTING: @UcmAgentService responding to importKey with error code ks.getErrorStatus() = "
    ...
    :try_end_f1
    .catch Ljava/security/KeyStoreException; {:try_start_a2 .. :try_end_f1} :catch_10f
    .catch Ljava/security/cert/CertificateException; {:try_start_a2 .. :try_end_f1} :catch_105
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_a2 .. :try_end_f1} :catch_fc
    .catch Ljava/io/IOException; {:try_start_a2 .. :try_end_f1} :catch_f2
...
.method private final greylist importKeyPair(Ljava/lang/String;[B[BLandroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 34
    .line 35
    sget-object v8, Lcom/samsung/android/knox/ucm/plugin/agent/UcmAgentProviderImpl;->KEY_EXTRA_PURPOSE:Ljava/lang/String;
    ...
    .line 55
    .line 56
    sget-object v11, Lcom/samsung/android/knox/ucm/plugin/agent/UcmAgentProviderImpl;->KEY_EXTRA_BLOCK_MODES:Ljava/lang/String;
    ...
    .line 76
    .line 77
    sget-object v11, Lcom/samsung/android/knox/ucm/plugin/agent/UcmAgentProviderImpl;->KEY_EXTRA_SIGNATURE_PADDINGS:Ljava/lang/String;
    ...
    .line 88
    :cond_58
    sget-object v8, Lcom/samsung/android/knox/ucm/plugin/agent/UcmAgentProviderImpl;->KEY_EXTRA_RANDOMIZED_ENCRYPTION:Ljava/lang/String;
    ...
    .line 94
    invoke-virtual {v7, v8}, Landroid/security/keystore/KeyProtection$Builder;->setRandomizedEncryptionRequired(Z)Landroid/security/keystore/KeyProtection$Builder;
    ...
    .line 215
    invoke-direct {v13, v14, v15, v9}, Lcom/samsung/android/knox/ucm/plugin/agent/UcmAgentService$UcmAgentLoadParameter;-><init>(IILandroid/os/Bundle;)V
    ...
    .line 226
    .line 227
    invoke-virtual {v3, v9, v13}, Landroid/os/Bundle;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 239
    .line 240
    invoke-virtual {v3, v9}, Ljava/security/KeyFactory;->generatePrivate(Ljava/security/spec/KeySpec;)Ljava/security/PrivateKey;
    ...
    :try_end_126
    .catch Ljava/security/KeyStoreException; {:try_start_99 .. :try_end_126} :catch_172
    .catch Ljava/security/cert/CertificateException; {:try_start_99 .. :try_end_126} :catch_168
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_99 .. :try_end_126} :catch_160
    .catch Ljava/io/IOException; {:try_start_99 .. :try_end_126} :catch_156
    .catch Ljava/security/spec/InvalidKeySpecException; {:try_start_99 .. :try_end_126} :catch_14c
    .catch Ljava/security/UnrecoverableKeyException; {:try_start_99 .. :try_end_126} :catch_142
    .catch Ljava/lang/IllegalArgumentException; {:try_start_99 .. :try_end_126} :catch_138
    .catch Ljava/lang/NullPointerException; {:try_start_99 .. :try_end_126} :catch_130
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_99 .. :try_end_126} :catch_127
    ...
    .line 307
    .line 308
    invoke-virtual {v8, v5, v11}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V
...
.method private final greylist saw(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 33
    :cond_21
    const-string v5, "saw uid:"

    .line 34
    .line 35
    invoke-static {v5}, Lcom/samsung/android/knox/ContextInfo$$ExternalSyntheticOutline0;->m(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v1, v4, p0}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V
    :try_end_ba
    .catch Ljava/security/KeyStoreException; {:try_start_44 .. :try_end_ba} :catch_f2
    .catch Ljava/security/cert/CertificateException; {:try_start_44 .. :try_end_ba} :catch_e8
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_44 .. :try_end_ba} :catch_e0
    .catch Ljava/io/IOException; {:try_start_44 .. :try_end_ba} :catch_d6
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_44 .. :try_end_ba} :catch_cd
    .catch Ljava/lang/IllegalArgumentException; {:try_start_44 .. :try_end_ba} :catch_c3
    .catch Ljava/lang/NullPointerException; {:try_start_44 .. :try_end_ba} :catch_bb
...
.method private final greylist sign(Ljava/lang/String;[BLjava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 195
    .line 196
    invoke-static {p3, v6}, Lcom/samsung/android/knox/ucm/plugin/service/Signature;->getInstance(Ljava/lang/String;Ljava/security/Provider;)Lcom/samsung/android/knox/ucm/plugin/service/Signature;
    ...
    .line 201
    .line 202
    const-string p1, "sign. Signature instance null "
    ...
    .line 206
    .line 207
    invoke-direct {p0, v5}, Lcom/samsung/android/knox/ucm/plugin/agent/UcmAgentService;->responseErrorWithNullBytes(I)Landroid/os/Bundle;
    ...
    .line 212
    :cond_d4
    invoke-virtual {p3, p4}, Lcom/samsung/android/knox/ucm/plugin/service/Signature;->setProperty(Landroid/os/Bundle;)V

    .line 213
    .line 214
    .line 215
    invoke-virtual {p3, p1}, Lcom/samsung/android/knox/ucm/plugin/service/Signature;->initSign(Ljava/security/PrivateKey;)V

    .line 216
    .line 217
    .line 218
    invoke-virtual {p3, p2}, Lcom/samsung/android/knox/ucm/plugin/service/Signature;->update([B)V

    .line 219
    .line 220
    .line 221
    invoke-virtual {p3}, Lcom/samsung/android/knox/ucm/plugin/service/Signature;->sign()[B
    ...
    .line 227
    .line 228
    invoke-virtual {p3}, Lcom/samsung/android/knox/ucm/plugin/service/Signature;->getErrorStatus()I
    ...
    invoke-virtual {v3, v1, p0}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V
    :try_end_eb
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_61 .. :try_end_eb} :catch_143
    .catch Ljava/security/InvalidKeyException; {:try_start_61 .. :try_end_eb} :catch_139
    .catch Ljava/security/UnrecoverableEntryException; {:try_start_61 .. :try_end_eb} :catch_12f
    .catch Ljava/security/KeyStoreException; {:try_start_61 .. :try_end_eb} :catch_125
    .catch Ljava/security/cert/CertificateException; {:try_start_61 .. :try_end_eb} :catch_11b
    .catch Ljava/io/IOException; {:try_start_61 .. :try_end_eb} :catch_111
    .catch Ljava/lang/IllegalArgumentException; {:try_start_61 .. :try_end_eb} :catch_107
    .catch Ljava/security/SignatureException; {:try_start_61 .. :try_end_eb} :catch_fd
    .catch Ljava/lang/NullPointerException; {:try_start_61 .. :try_end_eb} :catch_f5
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_61 .. :try_end_eb} :catch_ec
