...
# virtual methods
.method public final greylist addClipboardTextData(Ljava/lang/String;)Z
    .registers 4
...
.method public final greylist clearClipboardData()Z
    .registers 3
    ...
    .line 13
    .line 14
    invoke-virtual {p0}, Lcom/samsung/android/knox/devicesecurity/DeviceSecurityPolicy;->getMiscService()Lcom/samsung/android/knox/IMiscPolicy;
    ...
    .line 23
    .line 24
    invoke-interface {v0, p0}, Lcom/samsung/android/knox/IMiscPolicy;->clearClipboardData(Lcom/samsung/android/knox/ContextInfo;)Z
    ...
    .line 31
    .line 32
    const-string v1, "Failed to Clear ClipBoard!!!"
...
.method public final greylist formatStorageCard(Z)Z
    .registers 3
    ...
    .line 9
    .line 10
    invoke-interface {v0, p0, p1}, Lcom/samsung/android/knox/ISecurityPolicy;->formatStorageCard(Lcom/samsung/android/knox/ContextInfo;Z)Z
...
.method public final greylist getClipboardTextData()Ljava/lang/String;
    .registers 4
...
.method public final greylist getRequireDeviceEncryption(Landroid/content/ComponentName;)Z
    .registers 3
...
.method public final greylist getRequireStorageCardEncryption(Landroid/content/ComponentName;)Z
    .registers 3
...
.method public final greylist isExternalStorageEncrypted()Z
    .registers 3
...
.method public final greylist isInternalStorageEncrypted()Z
    .registers 3
...
.method public final greylist setExternalStorageEncryption(Z)V
    .registers 4
...
.method public final greylist setInternalStorageEncryption(Z)V
    .registers 4
...
.method public final greylist setRequireDeviceEncryption(Landroid/content/ComponentName;Z)V
    .registers 5
...
.method public final greylist setRequireStorageCardEncryption(Landroid/content/ComponentName;Z)V
    .registers 5
...
.method public final greylist wipeDevice(I)Z
    .registers 6
    ...
    :goto_18
    :try_start_18
    invoke-virtual {p0, v3}, Lcom/samsung/android/knox/devicesecurity/DeviceSecurityPolicy;->formatStorageCard(Z)Z
    ...
    move-result v0
    :try_end_1c
    .catch Landroid/os/RemoteException; {:try_start_18 .. :try_end_1c} :catch_3b
    ...
    :goto_23
    :try_start_23
    iget-object v2, p0, Lcom/samsung/android/knox/devicesecurity/DeviceSecurityPolicy;->mSecurityService:Lcom/samsung/android/knox/ISecurityPolicy;

    .line 36
    .line 37
    iget-object v3, p0, Lcom/samsung/android/knox/devicesecurity/DeviceSecurityPolicy;->mContextInfo:Lcom/samsung/android/knox/ContextInfo;

    .line 38
    .line 39
    invoke-interface {v2, v3, p1}, Lcom/samsung/android/knox/ISecurityPolicy;->wipeDevice(Lcom/samsung/android/knox/ContextInfo;I)Z
    :try_end_2a
    ...
    .line 44
    .line 45
    const-string v2, "Failed wipeDevice"
    ...
    .line 50
    :goto_32
    invoke-virtual {p0, v1}, Lcom/samsung/android/knox/devicesecurity/DeviceSecurityPolicy;->formatStorageCard(Z)Z
    ...
    move-result p0
    :try_end_36
    .catch Landroid/os/RemoteException; {:try_start_2b .. :try_end_36} :catch_38
