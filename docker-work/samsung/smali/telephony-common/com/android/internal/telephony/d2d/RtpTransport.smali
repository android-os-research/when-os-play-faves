...
# direct methods
.method public static synthetic blacklist $r8$lambda$8aLmhMRjdMbYgfpwExeranILgTM(Landroid/telephony/ims/RtpHeaderExtensionType;)Z
    .registers 1
...
.method public static synthetic blacklist $r8$lambda$E2Ic4KeotZ0Aq8eKmb0jPPkoFjA(Landroid/telephony/ims/RtpHeaderExtensionType;)Landroid/net/Uri;
    .registers 1
...
.method public static synthetic blacklist $r8$lambda$dBh1TCvaN0PHHHUR7FlRiRqQQ_k(Landroid/telephony/ims/RtpHeaderExtension;Landroid/telephony/ims/RtpHeaderExtensionType;)Z
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$n_SkcZtXs0RZVAhgOnMs0mcATC8(Landroid/telephony/ims/RtpHeaderExtensionType;)Ljava/lang/String;
    .registers 1
...
.method public static synthetic blacklist $r8$lambda$qq-ZNu_Bmu1UtX9Upvh3dQtiDTk(Lcom/android/internal/telephony/d2d/RtpTransport;Landroid/telephony/ims/RtpHeaderExtension;)Lcom/android/internal/telephony/d2d/Communicator$Message;
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$sIx1mfrlrjwYbaeqsMLGz9gQNr4(Lcom/android/internal/telephony/d2d/RtpTransport;Lcom/android/internal/telephony/d2d/Communicator$Message;)Landroid/telephony/ims/RtpHeaderExtension;
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$vyaSEPjeVfgBI2MVx-OoZjI-uds(Landroid/telephony/ims/RtpHeaderExtensionType;)Z
    .registers 1
...
.method public static synthetic blacklist $r8$lambda$zfJLoQnbhWML1hmuqjhnsIFdSUM(Landroid/net/Uri;Landroid/telephony/ims/RtpHeaderExtensionType;)Z
    .registers 2
...
.method private blacklist getRtpHeaderExtensionIdentifier(Landroid/net/Uri;)I
    ...
    new-instance v0, Lcom/android/internal/telephony/d2d/RtpTransport$$ExternalSyntheticLambda6;

    invoke-direct {v0, p1}, Lcom/android/internal/telephony/d2d/RtpTransport$$ExternalSyntheticLambda6;-><init>(Landroid/net/Uri;)V
...
.method private static synthetic blacklist lambda$extractMessage$5(Landroid/telephony/ims/RtpHeaderExtension;Landroid/telephony/ims/RtpHeaderExtensionType;)Z
    .registers 2
...
.method private static synthetic blacklist lambda$extractMessage$6(Landroid/telephony/ims/RtpHeaderExtensionType;)Landroid/net/Uri;
    .registers 1
...
.method private static synthetic blacklist lambda$getRtpHeaderExtensionIdentifier$7(Landroid/net/Uri;Landroid/telephony/ims/RtpHeaderExtensionType;)Z
    .registers 2
...
.method private static synthetic blacklist lambda$startNegotiation$0(Landroid/telephony/ims/RtpHeaderExtensionType;)Ljava/lang/String;
    .registers 1
...
.method private static synthetic blacklist lambda$startNegotiation$1(Landroid/telephony/ims/RtpHeaderExtensionType;)Z
    .registers 2
...
.method private static synthetic blacklist lambda$startNegotiation$2(Landroid/telephony/ims/RtpHeaderExtensionType;)Z
    .registers 2
...
.method public blacklist sendMessages(Ljava/util/Set;)V
    ...
    new-instance v1, Lcom/android/internal/telephony/d2d/RtpTransport$$ExternalSyntheticLambda2;

    invoke-direct {v1, p0}, Lcom/android/internal/telephony/d2d/RtpTransport$$ExternalSyntheticLambda2;-><init>(Lcom/android/internal/telephony/d2d/RtpTransport;)V
...
.method public blacklist startNegotiation()V
    ...
    new-instance v4, Lcom/android/internal/telephony/d2d/RtpTransport$$ExternalSyntheticLambda3;

    invoke-direct {v4}, Lcom/android/internal/telephony/d2d/RtpTransport$$ExternalSyntheticLambda3;-><init>()V
    ...
    const-string v3, "startNegotiation: supportedExtensions=%s"
    ...
    new-instance v3, Lcom/android/internal/telephony/d2d/RtpTransport$$ExternalSyntheticLambda4;

    invoke-direct {v3}, Lcom/android/internal/telephony/d2d/RtpTransport$$ExternalSyntheticLambda4;-><init>()V
    ...
    new-instance v2, Lcom/android/internal/telephony/d2d/RtpTransport$$ExternalSyntheticLambda5;

    invoke-direct {v2}, Lcom/android/internal/telephony/d2d/RtpTransport$$ExternalSyntheticLambda5;-><init>()V
    ...
    const-string v1, "startNegotiation: header extensions available, negotiation success"
    ...
    const-string v1, "startNegotiation: header extensions not available; negotiation failed"
    ...
    const-string v1, "startNegotiation: SDP negotiation not supported; negotiation complete"
