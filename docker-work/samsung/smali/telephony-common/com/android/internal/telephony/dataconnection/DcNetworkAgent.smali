...
# static fields
.field private static final blacklist NETWORK_UNWANTED_ANOMALY_WINDOW_MS:J

.field private static blacklist sInterfaceNames:Ljava/util/Map;
...
.field private static final blacklist sNetworkUnwantedCounter:Lcom/android/internal/telephony/SlidingWindowEventCounter;


# instance fields
.field public final blacklist keepaliveTracker:Lcom/android/internal/telephony/dataconnection/DcNetworkAgent$DcKeepaliveTracker;
...
.field private final blacklist mNetCapsLocalLog:Lcom/android/internal/telephony/LocalLog;

.field private blacklist mNetworkCapabilities:Landroid/net/NetworkCapabilities;

.field private final blacklist mPhone:Lcom/android/internal/telephony/Phone;

.field private final blacklist mQosCallbackExecutor:Ljava/util/concurrent/Executor;

.field private final blacklist mQosCallbackTracker:Lcom/android/internal/telephony/data/QosCallbackTracker;
...
# direct methods
.method public static synthetic blacklist $r8$lambda$Vlk2QaGhvCMIdm3jNEM1VACGtMY(Lcom/android/internal/telephony/dataconnection/DcNetworkAgent;ILandroid/net/QosFilter;)V
    .registers 3
...
.method public static synthetic blacklist $r8$lambda$m6uSxr-dpLvazQSZ6ECF72L3BzU(Lcom/android/internal/telephony/dataconnection/DcNetworkAgent;I)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$oB25Fbykg1OsTSYM-E30N3IhPlw(Lcom/android/internal/telephony/dataconnection/DcNetworkAgent;Ljava/util/List;)V
    .registers 2
...
.method static bridge synthetic blacklist -$$Nest$fgetmId(Lcom/android/internal/telephony/dataconnection/DcNetworkAgent;)I
    .registers 1
...
.method static bridge synthetic blacklist -$$Nest$mlogd(Lcom/android/internal/telephony/dataconnection/DcNetworkAgent;Ljava/lang/String;)V
    .registers 2
...
.method static bridge synthetic blacklist -$$Nest$mloge(Lcom/android/internal/telephony/dataconnection/DcNetworkAgent;Ljava/lang/String;)V
    .registers 2
...
.method static bridge synthetic blacklist -$$Nest$sfgetsInterfaceNames()Ljava/util/Map;
    .registers 1
...
.method public constructor blacklist <init>(Lcom/android/internal/telephony/dataconnection/DataConnection;Lcom/android/internal/telephony/Phone;ILandroid/net/NetworkAgentConfig;Landroid/net/NetworkProvider;I)V
    .registers 16
...
.method private blacklist checkDuplicateInterface(ILjava/lang/String;)V
    .registers 6
...
.method private declared-synchronized blacklist isOwned(Lcom/android/internal/telephony/dataconnection/DataConnection;Ljava/lang/String;)Z
    .registers 5
    ...
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/dataconnection/DcNetworkAgent;->loge(Ljava/lang/String;)V
    :try_end_1a
    .catchall {:try_start_1 .. :try_end_1a} :catchall_4c
    ...
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/dataconnection/DcNetworkAgent;->loge(Ljava/lang/String;)V
    :try_end_47
    .catchall {:try_start_1e .. :try_end_47} :catchall_4c
...
.method private synthetic blacklist lambda$onQosCallbackRegistered$0(ILandroid/net/QosFilter;)V
    .registers 5
...
.method private synthetic blacklist lambda$onQosCallbackUnregistered$1(I)V
    .registers 2
...
.method private synthetic blacklist lambda$updateQosBearerSessions$2(Ljava/util/List;)V
    .registers 2
...
.method private blacklist trackNetworkUnwanted()V
    .registers 3
...
# virtual methods
.method public declared-synchronized blacklist acquireOwnership(Lcom/android/internal/telephony/dataconnection/DataConnection;I)V
    .registers 3
...
.method public declared-synchronized whitelist onBandwidthUpdateRequested()V
    .registers 4
...
.method public declared-synchronized whitelist onNetworkUnwanted()V
    .registers 6
    ...
    :try_end_40
    .catchall {:try_start_1d .. :try_end_40} :catchall_42
...
.method public declared-synchronized whitelist onStartSocketKeepalive(ILjava/time/Duration;Landroid/net/KeepalivePacketData;)V
    .registers 8
...
.method public declared-synchronized whitelist onStopSocketKeepalive(I)V
    .registers 4
...
.method public declared-synchronized whitelist onValidationStatus(ILandroid/net/Uri;)V
    .registers 6
...
.method public declared-synchronized blacklist releaseOwnership(Lcom/android/internal/telephony/dataconnection/DataConnection;)V
    .registers 4
    ...
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/dataconnection/DcNetworkAgent;->loge(Ljava/lang/String;)V
    :try_end_34
    .catchall {:try_start_e .. :try_end_34} :catchall_5a
...
.method public declared-synchronized blacklist sendLinkProperties(Landroid/net/LinkProperties;Lcom/android/internal/telephony/dataconnection/DataConnection;)V
    .registers 5
...
.method public declared-synchronized blacklist sendNetworkCapabilities(Landroid/net/NetworkCapabilities;Lcom/android/internal/telephony/dataconnection/DataConnection;)V
    .registers 5
    ...
    move-result p2
    :try_end_7
    .catchall {:try_start_1 .. :try_end_7} :catchall_84
    ...
    :try_end_82
    .catchall {:try_start_b .. :try_end_82} :catchall_84
...
.method public declared-synchronized blacklist sendNetworkScore(ILcom/android/internal/telephony/dataconnection/DataConnection;)V
    .registers 4
...
.method public declared-synchronized blacklist unregister(Lcom/android/internal/telephony/dataconnection/DataConnection;)V
    .registers 4
...
.method public declared-synchronized blacklist updateLegacySubtype(Lcom/android/internal/telephony/dataconnection/DataConnection;)V
    .registers 3

    monitor-enter p0

    :try_start_1
    const-string v0, "updateLegacySubtype"
...
.method blacklist updateQosBearerSessions(Ljava/util/List;)V
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
