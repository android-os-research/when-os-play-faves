...
.field private final blacklist mInstalledPackageCerts:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
...
.field private final blacklist mRegistrantList:Lcom/android/internal/telephony/RegistrantList;
...
# direct methods
.method static bridge synthetic blacklist -$$Nest$fgetmPackageManager(Lcom/android/internal/telephony/CarrierPrivilegesTracker;)Landroid/content/pm/PackageManager;
    .registers 1
...
.method public constructor blacklist <init>(Landroid/os/Looper;Lcom/android/internal/telephony/Phone;Landroid/content/Context;)V
    .registers 6
    ...
    const-string p2, "telephony_registry"
...
.method private blacklist handlePackageAddedReplacedOrChanged(Ljava/lang/String;)V
    ...
    move-result-object p1
    :try_end_c
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_3 .. :try_end_c} :catch_19
...
.method private blacklist handleRegisterListener(Lcom/android/internal/telephony/Registrant;)V
    .registers 4
...
.method private blacklist handleSimStateChanged(II)V
    ...
    iput-boolean p1, p0, Lcom/android/internal/telephony/CarrierPrivilegesTracker;->mSimIsReadyButNotLoaded:Z
    :try_end_1c
    .catchall {:try_start_1a .. :try_end_1c} :catchall_8e
...
.method private blacklist handleUnregisterListener(Landroid/os/Handler;)V
    .registers 2
...
.method private static blacklist intSetToArray(Ljava/util/Set;)[I
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private blacklist isPackagePrivileged(Ljava/lang/String;Ljava/util/Set;)Z
    .registers 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private blacklist maybeUpdatePrivilegedPackagesAndNotifyRegistrants()V
    ...
    move-result v1
    :try_end_13
    .catchall {:try_start_d .. :try_end_13} :catchall_111
    ...
    move-result v4
    :try_end_5d
    .catchall {:try_start_1f .. :try_end_5d} :catchall_111
    ...
    :try_end_72
    .catchall {:try_start_70 .. :try_end_72} :catchall_106
    ...
    :try_end_d7
    .catchall {:try_start_86 .. :try_end_d7} :catchall_99
...
.method private blacklist updateCertsForPackage(Landroid/content/pm/PackageInfo;)V
    .registers 6
...
.method public blacklist dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V
    :try_end_5e
    .catchall {:try_start_32 .. :try_end_5e} :catchall_c0
...
.method public blacklist getCarrierPackageNamesForIntent(Landroid/content/Intent;)Ljava/util/List;
    ...
    move-result-object p1
    :try_end_11
    .catchall {:try_start_9 .. :try_end_11} :catchall_a9
    ...
    move-result-object p1
    :try_end_5f
    .catchall {:try_start_57 .. :try_end_5f} :catchall_9e
    ...
    :try_end_94
    .catchall {:try_start_69 .. :try_end_94} :catchall_9e
...
.method public blacklist getCarrierPrivilegeStatusForPackage(Ljava/lang/String;)I
    ...
    :try_end_f
    .catchall {:try_start_d .. :try_end_f} :catchall_32
...
.method public blacklist getCarrierPrivilegeStatusForUid(I)I
    ...
    iget-boolean v0, p0, Lcom/android/internal/telephony/CarrierPrivilegesTracker;->mSimIsReadyButNotLoaded:Z
    :try_end_b
    .catchall {:try_start_9 .. :try_end_b} :catchall_2a
...
.method public blacklist registerCarrierPrivilegesListener(Landroid/os/Handler;ILjava/lang/Object;)V
    .registers 5
...
.method public blacklist unregisterCarrierPrivilegesListener(Landroid/os/Handler;)V
    .registers 3
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
