...
# direct methods
.method public static synthetic blacklist $r8$lambda$7oose0tYhwPsBvAjTon9B60KcP0(I)[Ljava/lang/String;
    .registers 1
...
.method public static synthetic blacklist $r8$lambda$_t3S7XJAGi2lGZbrrIqVHr7oKPg(I)[Ljava/lang/String;
    .registers 1
...
.method public static synthetic blacklist $r8$lambda$iokZKurxt-VqPCSqDMm-wUgsa-k(ILjava/lang/Integer;)Z
    .registers 2
...
.method private declared-synchronized blacklist buildProto()Lcom/android/internal/telephony/nano/TelephonyProto$TelephonyLog;
    ...
    :try_end_11b
    .catchall {:try_start_1 .. :try_end_11b} :catchall_11d
...
.method private blacklist convertEmergencyNumberToEmergencyNumberInfo(Landroid/telephony/emergency/EmergencyNumber;)Lcom/android/internal/telephony/nano/TelephonyProto$EmergencyNumberInfo;
    ...
    new-instance v1, Lcom/android/internal/telephony/metrics/TelephonyMetrics$$ExternalSyntheticLambda2;

    invoke-direct {v1}, Lcom/android/internal/telephony/metrics/TelephonyMetrics$$ExternalSyntheticLambda2;-><init>()V
...
.method private static synthetic blacklist lambda$convertEmergencyNumberToEmergencyNumberInfo$1(I)[Ljava/lang/String;
    .registers 1
...
.method private static synthetic blacklist lambda$updateActiveSubscriptionInfoList$0(ILjava/lang/Integer;)Z
    .registers 2
...
.method private static synthetic blacklist lambda$writeCarrierIdMatchingEvent$2(I)[Ljava/lang/String;
    .registers 1
...
.method private declared-synchronized blacklist printAllMetrics(Ljava/io/PrintWriter;)V
    ...
    if-eq v11, v7, :cond_374

    if-eq v11, v3, :cond_36e

    const/4 v12, 0x3

    if-eq v11, v12, :cond_368

    const/4 v12, 0x4

    if-eq v11, v12, :cond_362
    ...
    if-eq v11, v12, :cond_3d3

    const/4 v12, 0x7

    if-ne v11, v12, :cond_39f

    goto :goto_3d3

    :cond_39f
    if-ne v11, v5, :cond_438
    ...
    :try_end_647
    .catchall {:try_start_1 .. :try_end_647} :catchall_649
...
.method private declared-synchronized blacklist reset()V
    ...
    :try_end_1ef
    .catchall {:try_start_1 .. :try_end_1ef} :catchall_1f1
...
.method public declared-synchronized blacklist updateActiveSubscriptionInfoList(Ljava/util/List;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/metrics/TelephonyMetrics;->addTelephonyEvent(Lcom/android/internal/telephony/nano/TelephonyProto$TelephonyEvent;)V
    :try_end_ca
    .catchall {:try_start_1 .. :try_end_ca} :catchall_cd
...
.method public blacklist writeCarrierIdMatchingEvent(IIILjava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/CarrierResolver$CarrierMatchingRule;)V
    ...
    new-instance p4, Lcom/android/internal/telephony/metrics/TelephonyMetrics$$ExternalSyntheticLambda1;

    invoke-direct {p4}, Lcom/android/internal/telephony/metrics/TelephonyMetrics$$ExternalSyntheticLambda1;-><init>()V
...
.method public declared-synchronized blacklist writeImsSetFeatureValue(IIII)V
    ...
    move-result p2
    :try_end_49
    .catchall {:try_start_1 .. :try_end_49} :catchall_80
    ...
    :try_end_7e
    .catchall {:try_start_4d .. :try_end_7e} :catchall_80
...
.method public declared-synchronized blacklist writeOnImsCapabilities(IILandroid/telephony/ims/feature/MmTelFeature$MmTelCapabilities;)V
    ...
    move-result p3
    :try_end_5b
    .catchall {:try_start_1 .. :try_end_5b} :catchall_89
    ...
    :try_end_87
    .catchall {:try_start_5f .. :try_end_87} :catchall_89
...
.method public declared-synchronized blacklist writeOnImsConnectionState(IILandroid/telephony/ims/ImsReasonInfo;)V
    ...
    move-result p2
    :try_end_41
    .catchall {:try_start_1 .. :try_end_41} :catchall_7d
    ...
    invoke-direct {p0, v0, v1, p1, p2}, Lcom/android/internal/telephony/metrics/TelephonyMetrics;->annotateInProgressSmsSession(JILcom/android/internal/telephony/metrics/SmsSessionEventBuilder;)V
    :try_end_7b
    .catchall {:try_start_45 .. :try_end_7b} :catchall_7d
...
.method public declared-synchronized blacklist writeServiceStateChanged(ILandroid/telephony/ServiceState;)V
    ...
    move-result v0
    :try_end_30
    .catchall {:try_start_1 .. :try_end_30} :catchall_61
    ...
    invoke-direct {p0, v0, v1, p1, p2}, Lcom/android/internal/telephony/metrics/TelephonyMetrics;->annotateInProgressSmsSession(JILcom/android/internal/telephony/metrics/SmsSessionEventBuilder;)V
    :try_end_5f
    .catchall {:try_start_34 .. :try_end_5f} :catchall_61
...
.method public declared-synchronized blacklist writeSetPreferredNetworkType(II)V
    ...
    move-result p2
    :try_end_25
    .catchall {:try_start_1 .. :try_end_25} :catchall_40
    ...
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/metrics/TelephonyMetrics;->addTelephonyEvent(Lcom/android/internal/telephony/nano/TelephonyProto$TelephonyEvent;)V
    :try_end_3e
    .catchall {:try_start_29 .. :try_end_3e} :catchall_40
