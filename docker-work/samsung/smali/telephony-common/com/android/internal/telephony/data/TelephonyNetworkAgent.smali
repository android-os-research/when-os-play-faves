...
.field private final blacklist mNetworkAgentConfig:Landroid/net/NetworkAgentConfig;
...
# direct methods
.method public static synthetic blacklist $r8$lambda$1IlNeBSxo0hYY3I5_9TZgWKwxCY(ILandroid/net/QosFilter;Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;)V
    .registers 3
...
.method public static synthetic blacklist $r8$lambda$71pZ_J20okMi88r696r11vOK3hc(Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;I)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$AkLaMozFSnjTRGvNIYK_re6wPX8(ILandroid/net/Uri;Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;)V
    .registers 3
...
.method public static synthetic blacklist $r8$lambda$B0AnUcqWsKkPkYqcFU43MsRcPCc(Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;ILjava/time/Duration;Landroid/net/KeepalivePacketData;)V
    .registers 4
...
.method public static synthetic blacklist $r8$lambda$JdM4-2weuMyEkQpRxAnStfPKPio(ILcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$PfrBMkDHPadZFUrTfDmR1t_zmos(Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;I)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$SrgdSea-zfmdgm6UTgAbGf6s2ZQ(Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;ILandroid/net/Uri;)V
    .registers 3
...
.method public static synthetic blacklist $r8$lambda$VJBd8S55mkJ9ECJrI2elvsMUbdU(ILcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$dTUmVto6q5aGXhzPoGKgSCitKv8(Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;ILandroid/net/QosFilter;)V
    .registers 3
...
.method public static synthetic blacklist $r8$lambda$pwncpDVIggbmXQ2CaqgMvv-ddP4(ILjava/time/Duration;Landroid/net/KeepalivePacketData;Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;)V
    .registers 4
...
.method private static synthetic blacklist lambda$onQosCallbackRegistered$6(Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;ILandroid/net/QosFilter;)V
    .registers 3
...
.method private static synthetic blacklist lambda$onQosCallbackRegistered$7(ILandroid/net/QosFilter;Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;)V
    .registers 4
...
.method private static synthetic blacklist lambda$onQosCallbackUnregistered$8(Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;I)V
    .registers 2
...
.method private static synthetic blacklist lambda$onQosCallbackUnregistered$9(ILcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;)V
    .registers 3
...
.method private static synthetic blacklist lambda$onStartSocketKeepalive$2(Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;ILjava/time/Duration;Landroid/net/KeepalivePacketData;)V
    .registers 4
...
.method private static synthetic blacklist lambda$onStartSocketKeepalive$3(ILjava/time/Duration;Landroid/net/KeepalivePacketData;Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;)V
    .registers 5

    .line 237
    new-instance v0, Lcom/android/internal/telephony/data/TelephonyNetworkAgent$$ExternalSyntheticLambda9;

    invoke-direct {v0, p3, p0, p1, p2}, Lcom/android/internal/telephony/data/TelephonyNetworkAgent$$ExternalSyntheticLambda9;-><init>(Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;ILjava/time/Duration;Landroid/net/KeepalivePacketData;)V
...
.method private static synthetic blacklist lambda$onStopSocketKeepalive$4(Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;I)V
    .registers 2
...
.method private static synthetic blacklist lambda$onStopSocketKeepalive$5(ILcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;)V
    .registers 3
...
.method private static synthetic blacklist lambda$onValidationStatus$0(Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;ILandroid/net/Uri;)V
    .registers 3
...
.method private static synthetic blacklist lambda$onValidationStatus$1(ILandroid/net/Uri;Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;)V
    .registers 4

    .line 207
    new-instance v0, Lcom/android/internal/telephony/data/TelephonyNetworkAgent$$ExternalSyntheticLambda6;

    invoke-direct {v0, p2, p0, p1}, Lcom/android/internal/telephony/data/TelephonyNetworkAgent$$ExternalSyntheticLambda6;-><init>(Lcom/android/internal/telephony/data/TelephonyNetworkAgent$TelephonyNetworkAgentCallback;ILandroid/net/Uri;)V
...
.method public blacklist notifyQosSessionAvailable(IILandroid/net/QosSessionAttributes;)V
    .registers 4
...
.method public blacklist notifyQosSessionLost(III)V
    .registers 4
...
.method public whitelist onQosCallbackUnregistered(I)V
    ...
    invoke-direct {v0, p1}, Lcom/android/internal/telephony/data/TelephonyNetworkAgent$$ExternalSyntheticLambda0;-><init>(I)V
...
.method public whitelist onStartSocketKeepalive(ILjava/time/Duration;Landroid/net/KeepalivePacketData;)V
    ...
    invoke-direct {v0, p1, p2, p3}, Lcom/android/internal/telephony/data/TelephonyNetworkAgent$$ExternalSyntheticLambda2;-><init>(ILjava/time/Duration;Landroid/net/KeepalivePacketData;)V
...
.method public whitelist onValidationStatus(ILandroid/net/Uri;)V
    ...
    invoke-direct {v0, p1, p2}, Lcom/android/internal/telephony/data/TelephonyNetworkAgent$$ExternalSyntheticLambda3;-><init>(ILandroid/net/Uri;)V
