...
# static fields
.field private static final blacklist POLICY_PULL_DAILY:Landroid/app/StatsManager$PullAtomMetadata;
...
# direct methods
.method public static synthetic blacklist $r8$lambda$3i1txjwUqApQZ6xnzGHZvb65tDE(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$CellularServiceState;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$62YNYd8A6z6XkWb8MmSVTVwTSjk(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$PresenceNotifyEvent;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$7EndRFHqTeKi_3dP4Fc9GMhl4Z8(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$CellularDataServiceSwitch;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$8uwxuwiwv8NBwoDH3unrAqH3V6s(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$GbaEvent;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$EZl8eClSJsKg7bbwAnoMNjC0u8c(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$SipTransportSession;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$EiIvGyrHLrBvry-J4_W4uRazkTI(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$NetworkRequestsV2;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$Ixz_EYhdji-oTmtrqGb6IpmCGQ4(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$OutgoingSms;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$JHZMk6n6u2wfQM16WZEfGv4hahA(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$UceEventStats;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$TlGB4_g2nz01u0loq_WBIHXIaBg(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$ImsRegistrationServiceDescStats;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$VcVeOAZ1Z1V2pSd6dMx7opf1vqw(Lcom/android/internal/telephony/nano/PersistAtomsProto$VoiceCallRatUsage;)J
    .registers 3
...
.method public static synthetic blacklist $r8$lambda$Xbzt89skyBY3kKI8XaF97FllJIo(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$ImsRegistrationStats;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$ZZoIiFopPD6RatQmvOK_ndknJLg(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$VoiceCallSession;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$_QS-wcCPEGsxvpo8R5eJqD8l2uY(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$SipMessageResponse;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$fMS-SDmyxBP91NpVpwTDESOlEAo(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$ImsDedicatedBearerListenerEvent;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$gH2yOQ9vEPCYQy-oix7fehtZDTg(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$VoiceCallRatUsage;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$nIW-u-jmDFo2ynQPlcVOxRvrmA8(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$RcsAcsProvisioningStats;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$qNIvzk3VBDBeJznry98J4nL2C8Y(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$RcsClientProvisioningStats;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$qNyx2a44TW5YRcxdeu9HOeDDcaY(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$ImsDedicatedBearerEvent;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$r6FbOoHs4Aw6BzoUTCdSLAFDJJc(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$ImsRegistrationFeatureTagStats;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$v-F0Myc4UDJIM5eMC8slp8MzV94(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$SipDelegateStats;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$vGDGWY5X76__sdp71USzoWpyrJw(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$ImsRegistrationTermination;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$vnyK5Wc5U79Bv7gcSX7XmOcLB1U(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$DataCallSession;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$x8RtDQuztiWKB5d7b_x4im5UxyA(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$SipTransportFeatureTagStats;)V
    .registers 2
...
.method public static synthetic blacklist $r8$lambda$xi2tr438c0ArfZgaZ_4aSOb6C9c(Lcom/android/internal/telephony/nano/PersistAtomsProto$VoiceCallRatUsage;)Z
    .registers 1
...
.method public static synthetic blacklist $r8$lambda$yEWBbYEKfZzWOtKQ7XVVcvV6XZk(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$IncomingSms;)V
    .registers 2
...
.method public constructor blacklist <init>(Landroid/content/Context;Lcom/android/internal/telephony/metrics/PersistAtomsStorage;)V
    .registers 5
...
.method private static blacklist getPhonesIfAny()[Lcom/android/internal/telephony/Phone;
    .registers 1
...
.method private static synthetic blacklist lambda$pullCellularDataServiceSwitch$7(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$CellularDataServiceSwitch;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullCellularServiceState$8(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$CellularServiceState;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullDataCallSession$6(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$DataCallSession;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullGbaEvent$24(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$GbaEvent;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullImsDedicatedBearerEvent$20(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$ImsDedicatedBearerEvent;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullImsDedicatedBearerListenerEvent$19(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$ImsDedicatedBearerListenerEvent;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullImsRegistrationFeatureTagStats$12(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$ImsRegistrationFeatureTagStats;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullImsRegistrationServiceDescStats$21(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$ImsRegistrationServiceDescStats;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullImsRegistrationStats$9(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$ImsRegistrationStats;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullImsRegistrationTermination$10(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$ImsRegistrationTermination;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullIncomingSms$4(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$IncomingSms;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullOutgoingSms$5(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$OutgoingSms;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullPresenceNotifyEvent$23(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$PresenceNotifyEvent;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullRcsAcsProvisioningStats$14(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$RcsAcsProvisioningStats;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullRcsClientProvisioningStats$13(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$RcsClientProvisioningStats;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullSipDelegateStats$15(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$SipDelegateStats;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullSipMessageResponse$17(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$SipMessageResponse;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullSipTransportFeatureTagStats$16(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$SipTransportFeatureTagStats;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullSipTransportSession$18(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$SipTransportSession;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullTelephonyNetworkRequestsV2$11(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$NetworkRequestsV2;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullUceEventStats$22(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$UceEventStats;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullVoiceCallRatUsages$0(Lcom/android/internal/telephony/nano/PersistAtomsProto$VoiceCallRatUsage;)J
    .registers 5
...
.method private static synthetic blacklist lambda$pullVoiceCallRatUsages$1(Lcom/android/internal/telephony/nano/PersistAtomsProto$VoiceCallRatUsage;)Z
    .registers 5
...
.method private static synthetic blacklist lambda$pullVoiceCallRatUsages$2(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$VoiceCallRatUsage;)V
    .registers 2
...
.method private static synthetic blacklist lambda$pullVoiceCallSessions$3(Ljava/util/List;Lcom/android/internal/telephony/nano/PersistAtomsProto$VoiceCallSession;)V
    .registers 2
...
.method private static blacklist pullDeviceTelephonyProperties(Ljava/util/List;)I
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static blacklist pullSimSlotState(Ljava/util/List;)I
    ...
    move-result-object v0
    :try_end_4
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_4} :catch_15
...
.method private blacklist registerAtom(ILandroid/app/StatsManager$PullAtomMetadata;)V
    .registers 5
...
.method private static blacklist round(JJ)J
    .registers 6
...
.method public whitelist onPullAtom(ILjava/util/List;)I
    ...
    const-string p1, "unexpected atom ID %d"
