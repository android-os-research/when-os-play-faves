...
.annotation build Landroid/compat/annotation/UnsupportedAppUsage;
    implicitMember = "values()[Lcom/android/internal/telephony/DriverCall$State;"
.end annotation
...
.method static constructor blacklist <clinit>()V
    ...
    .line 35
    new-instance v1, Lcom/android/internal/telephony/DriverCall$State;

    const-string v3, "HOLDING"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/android/internal/telephony/DriverCall$State;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/android/internal/telephony/DriverCall$State;->HOLDING:Lcom/android/internal/telephony/DriverCall$State;

    .line 37
    new-instance v3, Lcom/android/internal/telephony/DriverCall$State;

    const-string v5, "DIALING"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/android/internal/telephony/DriverCall$State;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/android/internal/telephony/DriverCall$State;->DIALING:Lcom/android/internal/telephony/DriverCall$State;

    .line 39
    new-instance v5, Lcom/android/internal/telephony/DriverCall$State;

    const-string v7, "ALERTING"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/android/internal/telephony/DriverCall$State;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/android/internal/telephony/DriverCall$State;->ALERTING:Lcom/android/internal/telephony/DriverCall$State;

    .line 41
    new-instance v7, Lcom/android/internal/telephony/DriverCall$State;

    const-string v9, "INCOMING"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/android/internal/telephony/DriverCall$State;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/android/internal/telephony/DriverCall$State;->INCOMING:Lcom/android/internal/telephony/DriverCall$State;

    .line 43
    new-instance v9, Lcom/android/internal/telephony/DriverCall$State;

    const-string v11, "WAITING"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lcom/android/internal/telephony/DriverCall$State;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lcom/android/internal/telephony/DriverCall$State;->WAITING:Lcom/android/internal/telephony/DriverCall$State;

    const/4 v11, 0x6

    new-array v11, v11, [Lcom/android/internal/telephony/DriverCall$State;
    ...
    .line 30
    sput-object v11, Lcom/android/internal/telephony/DriverCall$State;->$VALUES:[Lcom/android/internal/telephony/DriverCall$State;
