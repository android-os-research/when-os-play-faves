...
# direct methods
.method public static synthetic blacklist $r8$lambda$-jzDkKzw99cP01kTpOmr3omj5dI(Lcom/android/internal/telephony/d2d/DtmfTransport;)V
    .registers 1
...
.method public static synthetic blacklist $r8$lambda$Rp8FpEmkYNbZoYrQdT-neWA6I7k(Lcom/android/internal/telephony/d2d/DtmfTransport;)V
    .registers 1
...
.method public static synthetic blacklist $r8$lambda$jbYwl4D3F8su-M6XClYUlaRg7x8(Lcom/android/internal/telephony/d2d/DtmfTransport;)V
    .registers 1
...
.method private blacklist handleProbeMessage()V
    ...
    monitor-exit v0
    :try_end_1c
    .catchall {:try_start_3 .. :try_end_1c} :catchall_67
...
.method private blacklist handleReceivedDigit(C)V
    ...
    monitor-exit v0
    :try_end_61
    .catchall {:try_start_54 .. :try_end_61} :catchall_7a
    ...
    monitor-exit v0
    :try_end_bf
    .catchall {:try_start_80 .. :try_end_bf} :catchall_bd
...
.method public blacklist startNegotiation()V
    ...
    const-string v1, "startNegotiation: can\'t start negotiation as not idle."
    ...
    const-string v1, "startNegotiation: starting negotiation."
