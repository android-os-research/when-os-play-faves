...
.field private final blacklist mChannelLock:Ljava/lang/Object;
...
.method static bridge synthetic blacklist -$$Nest$fgetmChannelLock(Lcom/android/internal/telephony/uicc/euicc/apdu/ApduSender;)Ljava/lang/Object;
    .registers 1
...
.method static bridge synthetic blacklist -$$Nest$fgetmSupportExtendedApdu(Lcom/android/internal/telephony/uicc/euicc/apdu/ApduSender;)Z
    .registers 1
...
.method static bridge synthetic blacklist -$$Nest$mcloseAndReturn(Lcom/android/internal/telephony/uicc/euicc/apdu/ApduSender;I[BLjava/lang/Throwable;Lcom/android/internal/telephony/uicc/euicc/apdu/ApduSenderResultCallback;Landroid/os/Handler;)V
    .registers 6
...
.method static bridge synthetic blacklist -$$Nest$msendCommand(Lcom/android/internal/telephony/uicc/euicc/apdu/ApduSender;Ljava/util/List;ILcom/android/internal/telephony/uicc/euicc/apdu/ApduSenderResultCallback;Landroid/os/Handler;)V
    .registers 5
...
.method static bridge synthetic blacklist -$$Nest$smlogv(Ljava/lang/String;)V
    .registers 1
...
.method public constructor blacklist <init>(Lcom/android/internal/telephony/CommandsInterface;Ljava/lang/String;Z)V
    .registers 5
...
.method private blacklist sendCommand(Ljava/util/List;ILcom/android/internal/telephony/uicc/euicc/apdu/ApduSenderResultCallback;Landroid/os/Handler;)V
    .registers 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public blacklist send(Lcom/android/internal/telephony/uicc/euicc/apdu/RequestProvider;Lcom/android/internal/telephony/uicc/euicc/apdu/ApduSenderResultCallback;Landroid/os/Handler;)V
    ...
    :try_end_21
    .catch Ljava/lang/InterruptedException; {:try_start_1a .. :try_end_21} :catch_21
    .catchall {:try_start_1a .. :try_end_21} :catchall_4e
    ...
    monitor-exit v0
    :try_end_41
    .catchall {:try_start_21 .. :try_end_41} :catchall_4e
