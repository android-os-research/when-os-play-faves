.class public final Lcom/android/internal/telephony/util/NetworkStackConstants;
...
.method static constructor blacklist <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/telephony/util/NetworkStackConstants;->ETHER_BROADCAST:[B

    const/4 v0, -0x1

    .line 100
    invoke-static {v0, v0, v0, v0}, Lcom/android/internal/telephony/util/NetworkStackConstants;->makeInet4Address(BBBB)Ljava/net/Inet4Address;

    move-result-object v0

    sput-object v0, Lcom/android/internal/telephony/util/NetworkStackConstants;->IPV4_ADDR_ALL:Ljava/net/Inet4Address;
    ...
    sput-object v0, Lcom/android/internal/telephony/util/NetworkStackConstants;->IPV4_ADDR_ANY:Ljava/net/Inet4Address;
    ...
    invoke-static {v0}, Lcom/android/internal/telephony/util/NetworkStackConstants;->makeInet6Address([B)Ljava/net/Inet6Address;

    move-result-object v0

    sput-object v0, Lcom/android/internal/telephony/util/NetworkStackConstants;->IPV6_ADDR_ANY:Ljava/net/Inet6Address;
    ...
    sput-object v0, Lcom/android/internal/telephony/util/NetworkStackConstants;->IPV6_ADDR_ALL_NODES_MULTICAST:Ljava/net/Inet6Address;
    ...
    sput-object v0, Lcom/android/internal/telephony/util/NetworkStackConstants;->IPV6_ADDR_ALL_ROUTERS_MULTICAST:Ljava/net/Inet6Address;
    ...
    sput-object v0, Lcom/android/internal/telephony/util/NetworkStackConstants;->IPV6_ADDR_ALL_HOSTS_MULTICAST:Ljava/net/Inet6Address;
...
.method private constructor blacklist <init>()V
    ...
    const-string v0, "This class is not to be instantiated"
...
.method private static blacklist makeInet4Address(BBBB)Ljava/net/Inet4Address;
    ...
    :try_end_15
    .catch Ljava/net/UnknownHostException; {:try_start_1 .. :try_end_15} :catch_16
    ...
    const-string p1, "addr must be 4 bytes: this should never happen"
...
.method private static blacklist makeInet6Address([B)Ljava/net/Inet6Address;
    ...
    const-string v0, "addr must be 16 bytes: this should never happen"
