...
.method public static final blacklist mergeFrom(Lcom/android/phone/ecc/nano/MessageNano;[BII)Lcom/android/phone/ecc/nano/MessageNano;
    ...
    :try_end_b
    .catch Lcom/android/phone/ecc/nano/InvalidProtocolBufferNanoException; {:try_start_0 .. :try_end_b} :catch_14
...
.method public static final blacklist toByteArray(Lcom/android/phone/ecc/nano/MessageNano;[BII)V
    .registers 4

    .line 116
    :try_start_0
    invoke-static {p1, p2, p3}, Lcom/android/phone/ecc/nano/CodedOutputByteBufferNano;->newInstance([BII)Lcom/android/phone/ecc/nano/CodedOutputByteBufferNano;

    move-result-object p1

    .line 117
    invoke-virtual {p0, p1}, Lcom/android/phone/ecc/nano/MessageNano;->writeTo(Lcom/android/phone/ecc/nano/CodedOutputByteBufferNano;)V

    .line 118
    invoke-virtual {p1}, Lcom/android/phone/ecc/nano/CodedOutputByteBufferNano;->checkNoSpaceLeft()V
    :try_end_a
...
.method public static final blacklist toByteArray(Lcom/android/phone/ecc/nano/MessageNano;)[B
    .registers 4
    ...
    .line 101
    invoke-static {p0, v1, v2, v0}, Lcom/android/phone/ecc/nano/MessageNano;->toByteArray(Lcom/android/phone/ecc/nano/MessageNano;[BII)V
...
.method public blacklist getCachedSize()I
    ...
    .line 52
    iget v0, p0, Lcom/android/phone/ecc/nano/MessageNano;->cachedSize:I
    ...
    .line 56
    :cond_7
    iget p0, p0, Lcom/android/phone/ecc/nano/MessageNano;->cachedSize:I
...
.method public blacklist getSerializedSize()I
    ...
    .line 65
    invoke-virtual {p0}, Lcom/android/phone/ecc/nano/MessageNano;->computeSerializedSize()I
