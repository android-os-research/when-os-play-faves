...
.field protected mVideoFrameCount:I
...
.method private checkAudioLoopCount(J)V
    ...
    const-string v1, "seek to next frame\taudioLoopCount :"
...
.method private checkDecoderOutputBufferIndex(ILandroid/media/MediaCodec$BufferInfo;)Z
    ...
    .line 1586
    const-string v2, "video decoder: output buffers changed"
    ...
    .line 1596
    const-string v2, "video decoder: codec config buffer"
...
.method private checkEncoderOutputBufferIndex(I)Z
    ...
    .line 1510
    const-string v2, "video encoder: output buffers changed"
...
.method private sendVideoFramesToMuxer(ILandroid/media/MediaCodec$BufferInfo;)V
    ...
    :try_end_49
    .catch Ljava/lang/IllegalStateException; {:try_start_42 .. :try_end_49} :catch_4a
    ...
    :try_end_7b
    .catch Ljava/lang/IllegalStateException; {:try_start_76 .. :try_end_7b} :catch_7c
...
.method protected calculateIsDrop([BJ)V
    .registers 13
    .param p1, "a"    # [B
...
.method synthetic lambda$preprocessAudioOutputFormat$0$com-samsung-android-transcode-core-EncodeBase()V
    .registers 2
...
.method protected prepareVideoCodec()V
    ...
    .line 2582
    :cond_57
    const-string v9, "vendor.qti-ext-dec-forceNonUBWC.value"

    invoke-virtual {v3, v9, v5}, Landroid/media/MediaFormat;->setInteger(Ljava/lang/String;I)V

    .line 2583
    const-string v9, "vendor.qti-ext-imageformat-filter-enabled.value"

    invoke-virtual {v3, v9, v5}, Landroid/media/MediaFormat;->setInteger(Ljava/lang/String;I)V

    .line 2584
    const-string v9, "vendor.qti-ext-imageformat-filter-enableInplace.value"
    ...
    const-string v10, "vendor.qti-ext-imageformat-filter-clientcolorformat.value"
    ...
    :cond_6f
    :goto_6f
    const-string v9, "vendor.sec-dec-output.image-convert.value"

    invoke-virtual {v3, v9, v5}, Landroid/media/MediaFormat;->setInteger(Ljava/lang/String;I)V

    .line 2578
    const-string v9, "vendor.sec-ext-imageformat-filter-enableInplace.value"
    ...
    const-string v10, "vendor.sec-dec-output.image-convert-pixel-format.value"
    ...
    :try_end_115
    .catch Ljava/lang/Exception; {:try_start_af .. :try_end_115} :catch_116
...
.method protected sendFrametoEncoder()V
    ...
    :try_end_63
    .catch Ljava/lang/RuntimeException; {:try_start_2a .. :try_end_63} :catch_64
...
.method public updateCreationTime(Ljava/lang/String;Z)Z
    ...
    invoke-direct {v0, v6, v14}, Ljava/io/RandomAccessFile;-><init>(Ljava/io/File;Ljava/lang/String;)V
    :try_end_78
    .catch Ljava/io/IOException; {:try_start_71 .. :try_end_78} :catch_12e
    ...
    move-result v15
    :try_end_ba
    .catchall {:try_start_90 .. :try_end_ba} :catchall_87
    ...
    :try_end_dc
    .catchall {:try_start_bf .. :try_end_dc} :catchall_df
    ...
    invoke-static {v4, v0}, Lcom/samsung/android/transcode/util/LogS;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_113
    .catchall {:try_start_ec .. :try_end_113} :catchall_87
    ...
    invoke-virtual {v14}, Ljava/io/RandomAccessFile;->close()V
    :try_end_12b
    .catch Ljava/io/IOException; {:try_start_124 .. :try_end_12b} :catch_12c
