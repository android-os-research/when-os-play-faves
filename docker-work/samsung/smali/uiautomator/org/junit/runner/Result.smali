...
# direct methods
.method static bridge synthetic -$$Nest$fgetassumptionFailureCount(Lorg/junit/runner/Result;)Ljava/util/concurrent/atomic/AtomicInteger;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetcount(Lorg/junit/runner/Result;)Ljava/util/concurrent/atomic/AtomicInteger;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetfailures(Lorg/junit/runner/Result;)Ljava/util/concurrent/CopyOnWriteArrayList;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetignoreCount(Lorg/junit/runner/Result;)Ljava/util/concurrent/atomic/AtomicInteger;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetrunTime(Lorg/junit/runner/Result;)Ljava/util/concurrent/atomic/AtomicLong;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetstartTime(Lorg/junit/runner/Result;)Ljava/util/concurrent/atomic/AtomicLong;
    .registers 1
...
.method private constructor <init>(Lorg/junit/runner/Result$SerializedForm;)V
    ...
    .line 49
    invoke-static {p1}, Lorg/junit/runner/Result$SerializedForm;->-$$Nest$fgetfCount(Lorg/junit/runner/Result$SerializedForm;)Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 50
    invoke-static {p1}, Lorg/junit/runner/Result$SerializedForm;->-$$Nest$fgetfIgnoreCount(Lorg/junit/runner/Result$SerializedForm;)Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 51
    invoke-static {p1}, Lorg/junit/runner/Result$SerializedForm;->-$$Nest$fgetassumptionFailureCount(Lorg/junit/runner/Result$SerializedForm;)Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-static {p1}, Lorg/junit/runner/Result$SerializedForm;->-$$Nest$fgetfFailures(Lorg/junit/runner/Result$SerializedForm;)Ljava/util/List;
    ...
    invoke-static {p1}, Lorg/junit/runner/Result$SerializedForm;->-$$Nest$fgetfRunTime(Lorg/junit/runner/Result$SerializedForm;)J
    ...
    invoke-static {p1}, Lorg/junit/runner/Result$SerializedForm;->-$$Nest$fgetfStartTime(Lorg/junit/runner/Result$SerializedForm;)J
...
.method public createListener()Lorg/junit/runner/notification/RunListener;
    ...
    invoke-direct {v0, p0, v1}, Lorg/junit/runner/Result$Listener;-><init>(Lorg/junit/runner/Result;Lorg/junit/runner/Result$Listener-IA;)V
