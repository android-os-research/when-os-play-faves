...
# direct methods
.method static bridge synthetic -$$Nest$fgetassumptionFailureCount(Lorg/junit/runner/Result$SerializedForm;)Ljava/util/concurrent/atomic/AtomicInteger;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetfCount(Lorg/junit/runner/Result$SerializedForm;)Ljava/util/concurrent/atomic/AtomicInteger;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetfFailures(Lorg/junit/runner/Result$SerializedForm;)Ljava/util/List;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetfIgnoreCount(Lorg/junit/runner/Result$SerializedForm;)Ljava/util/concurrent/atomic/AtomicInteger;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetfRunTime(Lorg/junit/runner/Result$SerializedForm;)J
    .registers 3
...
.method static bridge synthetic -$$Nest$fgetfStartTime(Lorg/junit/runner/Result$SerializedForm;)J
    .registers 3
...
.method public constructor <init>(Lorg/junit/runner/Result;)V
    ...
    .line 182
    invoke-static {p1}, Lorg/junit/runner/Result;->-$$Nest$fgetcount(Lorg/junit/runner/Result;)Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 183
    invoke-static {p1}, Lorg/junit/runner/Result;->-$$Nest$fgetignoreCount(Lorg/junit/runner/Result;)Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 184
    invoke-static {p1}, Lorg/junit/runner/Result;->-$$Nest$fgetassumptionFailureCount(Lorg/junit/runner/Result;)Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-static {p1}, Lorg/junit/runner/Result;->-$$Nest$fgetfailures(Lorg/junit/runner/Result;)Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    .line 186
    invoke-static {p1}, Lorg/junit/runner/Result;->-$$Nest$fgetrunTime(Lorg/junit/runner/Result;)Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 187
    invoke-static {p1}, Lorg/junit/runner/Result;->-$$Nest$fgetstartTime(Lorg/junit/runner/Result;)Ljava/util/concurrent/atomic/AtomicLong;
...
.method public serialize(Ljava/io/ObjectOutputStream;)V
    ...
    .line 207
    iget-object v1, p0, Lorg/junit/runner/Result$SerializedForm;->assumptionFailureCount:Ljava/util/concurrent/atomic/AtomicInteger;

    const-string v2, "assumptionFailureCount"
