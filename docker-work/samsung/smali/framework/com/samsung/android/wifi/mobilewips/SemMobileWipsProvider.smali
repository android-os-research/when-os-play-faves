...
.method static constructor blacklist <clinit>()V
    ...
    .line 64
    const-string v1, "CREATE TABLE IF NOT EXISTS MobileWIPSWHITE(history_id INTEGER PRIMARY KEY AUTOINCREMENT,mac_addr TEXT, exception_type Integer DEFAULT 0, ssid_name TEXT ) "

    const-string v2, "CREATE TABLE IF NOT EXISTS MobileWIPSIE(history_id INTEGER PRIMARY KEY AUTOINCREMENT,mac_addr TEXT, frequency INTEGER, time_stamp LONG, seen_time LONG, ies varbinary, time_saved LONG, beacon_tsf LONG, beacon_seen LONG ) "

    const-string v3, "CREATE TABLE IF NOT EXISTS MobileWIPSDUMP(history_id INTEGER PRIMARY KEY AUTOINCREMENT,time_stamp LONG, attack_type Integer, reason TEXT) "
    ...
    .line 74
    const-string v1, "DROP TABLE IF EXISTS MobileWIPSWHITE"

    const-string v2, "DROP TABLE IF EXISTS MobileWIPSIE"

    const-string v3, "DROP TABLE IF EXISTS MobileWIPSDUMP"
    ...
    .line 81
    const-string v1, "com.samsung.server.wifi.mwips"
...
.method public whitelist query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    move-result-object v0
    :try_end_31
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_2b .. :try_end_31} :catch_7d
    ...
    .line 124
    const-string/jumbo v0, "sURI macher match"
    ...
    const-string/jumbo v6, "querying unknown URI: "
    ...
    .line 141
    const-string/jumbo v5, "query failed in downloads database"
