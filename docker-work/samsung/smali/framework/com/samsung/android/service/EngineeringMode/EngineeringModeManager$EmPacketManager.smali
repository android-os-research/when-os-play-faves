...
.method private blacklist parseGroupDb([BI)I
    ...
    :try_end_f4
    .catch Ljava/lang/Exception; {:try_start_37 .. :try_end_f4} :catch_fa
...
.method private blacklist parseIssuerInfo([BI)I
    ...
    if-eq v10, v12, :cond_e0

    if-eq v10, v6, :cond_e0
