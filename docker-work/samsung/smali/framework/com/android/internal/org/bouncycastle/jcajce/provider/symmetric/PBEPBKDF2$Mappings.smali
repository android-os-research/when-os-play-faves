.class public Lcom/android/internal/org/bouncycastle/jcajce/provider/symmetric/PBEPBKDF2$Mappings;
...
.method static constructor blacklist <clinit>()V
    ...
    .line 631
    const-class v0, Lcom/android/internal/org/bouncycastle/jcajce/provider/symmetric/PBEPBKDF2;

    invoke-virtual {v0}, Ljava/lang/Class;->getName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/android/internal/org/bouncycastle/jcajce/provider/symmetric/PBEPBKDF2$Mappings;->PREFIX:Ljava/lang/String;
...
.method public blacklist configure(Lcom/android/internal/org/bouncycastle/jcajce/provider/config/ConfigurableProvider;)V
    ...
    sget-object v1, Lcom/android/internal/org/bouncycastle/jcajce/provider/symmetric/PBEPBKDF2$Mappings;->PREFIX:Ljava/lang/String;
    ...
    const-string v2, "$PBKDF2WithHmacSHA224UTF8"
    ...
    const-string v2, "$PBKDF2WithHmacSHA256UTF8"
    ...
    const-string v2, "$PBKDF2WithHmacSHA384UTF8"
    ...
    const-string v2, "$PBKDF2WithHmacSHA512UTF8"
    ...
    const-string v2, "$PBEWithHmacSHA1AndAES_128"
    ...
    const-string v2, "SecretKeyFactory.PBEWithHmacSHA1AndAES_128"
    ...
    const-string v2, "$PBEWithHmacSHA224AndAES_128"
    ...
    const-string v2, "SecretKeyFactory.PBEWithHmacSHA224AndAES_128"
    ...
    const-string v2, "$PBEWithHmacSHA256AndAES_128"
    ...
    const-string v2, "SecretKeyFactory.PBEWithHmacSHA256AndAES_128"
    ...
    const-string v2, "$PBEWithHmacSHA384AndAES_128"
    ...
    const-string v2, "SecretKeyFactory.PBEWithHmacSHA384AndAES_128"
    ...
    const-string v2, "$PBEWithHmacSHA512AndAES_128"
    ...
    const-string v2, "SecretKeyFactory.PBEWithHmacSHA512AndAES_128"
    ...
    const-string v2, "$PBEWithHmacSHA1AndAES_256"
    ...
    const-string v2, "SecretKeyFactory.PBEWithHmacSHA1AndAES_256"
    ...
    const-string v2, "$PBEWithHmacSHA224AndAES_256"
    ...
    const-string v2, "SecretKeyFactory.PBEWithHmacSHA224AndAES_256"
    ...
    const-string v2, "$PBEWithHmacSHA256AndAES_256"
    ...
    const-string v2, "SecretKeyFactory.PBEWithHmacSHA256AndAES_256"
    ...
    const-string v2, "$PBEWithHmacSHA384AndAES_256"
    ...
    const-string v2, "SecretKeyFactory.PBEWithHmacSHA384AndAES_256"
    ...
    const-string v2, "$PBEWithHmacSHA512AndAES_256"
    ...
    const-string v2, "SecretKeyFactory.PBEWithHmacSHA512AndAES_256"
