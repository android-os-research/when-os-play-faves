...
.method public constructor blacklist <init>(Landroid/content/Context;)V
    ...
    new-instance v4, Lcom/android/server/SkpmATCmd;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v5

    invoke-direct {v4, v5}, Lcom/android/server/SkpmATCmd;-><init>(Landroid/content/Context;)V
    ...
    new-instance v4, Lcom/android/server/DevRootKeyATCmd;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v5

    invoke-direct {v4, v5}, Lcom/android/server/DevRootKeyATCmd;-><init>(Landroid/content/Context;)V
...
.method public blacklist executePseudoDrkAtCommnd(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_end_3f
    .catch Ljava/lang/Exception; {:try_start_27 .. :try_end_3f} :catch_1f9
    .catchall {:try_start_27 .. :try_end_3f} :catchall_1f1
    ...
    :try_end_98
    .catch Ljava/lang/Exception; {:try_start_85 .. :try_end_98} :catch_1ed
    .catchall {:try_start_85 .. :try_end_98} :catchall_1e9

    if-nez v5, :cond_b2

    .line 578
    :try_start_9a
    new-instance v5, Lcom/android/server/DevRootKeyATCmd;
    ...
    invoke-direct {v5, v6}, Lcom/android/server/DevRootKeyATCmd;-><init>(Landroid/content/Context;)V
    ...
    move-result v5
    :try_end_d6
    .catch Ljava/lang/Exception; {:try_start_b2 .. :try_end_d6} :catch_1ed
    .catchall {:try_start_b2 .. :try_end_d6} :catchall_1e9
    ...
    move-result-object v0
    :try_end_115
    .catch Ljava/lang/Exception; {:try_start_dc .. :try_end_115} :catch_ad
    .catchall {:try_start_dc .. :try_end_115} :catchall_a8
    ...
    move-result v5
    :try_end_11d
    .catch Ljava/lang/Exception; {:try_start_119 .. :try_end_11d} :catch_1ed
    .catchall {:try_start_119 .. :try_end_11d} :catchall_1e9
    ...
    move-result-object v0
    :try_end_1a4
    .catch Ljava/lang/Exception; {:try_start_120 .. :try_end_1a4} :catch_1e7
    .catchall {:try_start_120 .. :try_end_1a4} :catchall_240
    ...
    :try_end_1d5
    .catch Ljava/lang/Exception; {:try_start_1ad .. :try_end_1d5} :catch_1e7
    .catchall {:try_start_1ad .. :try_end_1d5} :catchall_240
    ...
    move-result-object v4
    :try_end_22c
    .catchall {:try_start_200 .. :try_end_22c} :catchall_240
