...
# virtual methods
.method public blacklist abandonSession(I)V
    .registers 2
...
.method public blacklist getAllSessions(I)Landroid/content/pm/ParceledListSlice;
    .registers 3
    .param p1, "userId"    # I
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public blacklist getMySessions(Ljava/lang/String;I)Landroid/content/pm/ParceledListSlice;
    .registers 4
...
.method public blacklist getSessionInfo(I)Landroid/content/pm/PackageInstaller$SessionInfo;
    .registers 3
    .param p1, "sessionId"    # I
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public blacklist openSession(I)Landroid/content/pm/IPackageInstallerSession;
    .registers 3
    .param p1, "sessionId"    # I
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public blacklist registerCallback(Landroid/content/pm/IPackageInstallerCallback;I)V
    .registers 3
...
.method public blacklist setPermissionsResult(IZ)V
    .registers 3
    .param p1, "sessionId"    # I
    .param p2, "accepted"    # Z
    .annotation system Ldalvik/annotation/Throws;
...
.method public blacklist uninstall(Landroid/content/pm/VersionedPackage;Ljava/lang/String;ILandroid/content/IntentSender;I)V
    .registers 6
...
.method public blacklist unregisterCallback(Landroid/content/pm/IPackageInstallerCallback;)V
    .registers 2
    .param p1, "callback"    # Landroid/content/pm/IPackageInstallerCallback;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public blacklist updateSessionAppIcon(ILandroid/graphics/Bitmap;)V
    .registers 3
    .param p1, "sessionId"    # I
...
.method public blacklist updateSessionAppLabel(ILjava/lang/String;)V
    .registers 3
    .param p1, "sessionId"    # I
