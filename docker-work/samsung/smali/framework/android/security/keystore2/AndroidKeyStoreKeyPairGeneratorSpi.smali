...
.method private blacklist constructKeyGenerationArguments()Ljava/util/Collection;
    ...
    invoke-static {v3, v1}, Landroid/security/keystore2/KeymasterUtils;->isSupportTagRSAOAEPMGFDigest(II)Z
    ...
    .line 928
    iget-object v3, p0, Landroid/security/keystore2/AndroidKeyStoreKeyPairGeneratorSpi;->mKeymasterEncryptionPaddings:[I
    ...
    invoke-static {v0, v2}, Landroid/security/keystore2/KeyStore2ParameterUtils;->addUserAuthArgs(Ljava/util/List;Landroid/security/keystore/UserAuthArgs;)V
    ...
    .line 944
    invoke-virtual {v3}, Landroid/security/keystore/KeyGenParameterSpec;->getKeyValidityStart()Ljava/util/Date;
    ...
    .line 950
    invoke-virtual {v3}, Landroid/security/keystore/KeyGenParameterSpec;->getKeyValidityForOriginationEnd()Ljava/util/Date;
    ...
    .line 956
    invoke-virtual {v3}, Landroid/security/keystore/KeyGenParameterSpec;->getKeyValidityForConsumptionEnd()Ljava/util/Date;
    ...
    .line 962
    invoke-virtual {v3}, Landroid/security/keystore/KeyGenParameterSpec;->getCertificateNotAfter()Ljava/util/Date;
    ...
    .line 968
    invoke-virtual {v3}, Landroid/security/keystore/KeyGenParameterSpec;->getCertificateNotBefore()Ljava/util/Date;
    ...
    .line 974
    invoke-virtual {v3}, Landroid/security/keystore/KeyGenParameterSpec;->getCertificateSerialNumber()Ljava/math/BigInteger;

    move-result-object v3

    .line 972
    invoke-static {v2, v3}, Landroid/security/keystore2/KeyStore2ParameterUtils;->makeBignum(ILjava/math/BigInteger;)Landroid/hardware/security/keymint/KeyParameter;
    ...
    .line 980
    invoke-virtual {v3}, Landroid/security/keystore/KeyGenParameterSpec;->getCertificateSubject()Ljavax/security/auth/x500/X500Principal;
    ...
    .line 978
    invoke-static {v2, v3}, Landroid/security/keystore2/KeyStore2ParameterUtils;->makeBytes(I[B)Landroid/hardware/security/keymint/KeyParameter;
    ...
    .line 987
    invoke-virtual {v3}, Landroid/security/keystore/KeyGenParameterSpec;->getMaxUsageCount()I
    ...
    invoke-virtual {v2}, Landroid/security/keystore/KeyGenParameterSpec;->isUniqueIdIncluded()Z
