...
.method public final blacklist readFromParcel(Landroid/os/Parcel;)V
    ...
    iput v2, p0, Landroid/hardware/security/keymint/KeyMintHardwareInfo;->versionNumber:I
    ...
    iput v2, p0, Landroid/hardware/security/keymint/KeyMintHardwareInfo;->securityLevel:I
    ...
    iput-object v2, p0, Landroid/hardware/security/keymint/KeyMintHardwareInfo;->keyMintName:Ljava/lang/String;
    ...
    iput-object v2, p0, Landroid/hardware/security/keymint/KeyMintHardwareInfo;->keyMintAuthorName:Ljava/lang/String;
    ...
    iput-boolean v2, p0, Landroid/hardware/security/keymint/KeyMintHardwareInfo;->timestampTokenRequired:Z
    :try_end_9c
    ...
    .end local p0    # "this":Landroid/hardware/security/keymint/KeyMintHardwareInfo;
    ...
    .restart local p0    # "this":Landroid/hardware/security/keymint/KeyMintHardwareInfo;
...
.method public final whitelist writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 31
    iget v1, p0, Landroid/hardware/security/keymint/KeyMintHardwareInfo;->versionNumber:I

    invoke-virtual {p1, v1}, Landroid/os/Parcel;->writeInt(I)V

    .line 32
    iget v1, p0, Landroid/hardware/security/keymint/KeyMintHardwareInfo;->securityLevel:I

    invoke-virtual {p1, v1}, Landroid/os/Parcel;->writeInt(I)V

    .line 33
    iget-object v1, p0, Landroid/hardware/security/keymint/KeyMintHardwareInfo;->keyMintName:Ljava/lang/String;

    invoke-virtual {p1, v1}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    .line 34
    iget-object v1, p0, Landroid/hardware/security/keymint/KeyMintHardwareInfo;->keyMintAuthorName:Ljava/lang/String;

    invoke-virtual {p1, v1}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    .line 35
    iget-boolean v1, p0, Landroid/hardware/security/keymint/KeyMintHardwareInfo;->timestampTokenRequired:Z
