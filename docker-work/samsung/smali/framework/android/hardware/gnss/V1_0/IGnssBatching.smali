...
# static fields
.field public static final blacklist kInterfaceName:Ljava/lang/String; = "android.hardware.gnss@1.0::IGnssBatching"


# direct methods
.method public static blacklist asInterface(Landroid/os/IHwBinder;)Landroid/hardware/gnss/V1_0/IGnssBatching;
    .registers 8
...
.method public static blacklist castFrom(Landroid/os/IHwInterface;)Landroid/hardware/gnss/V1_0/IGnssBatching;
    .registers 2
...
.method public static blacklist getService()Landroid/hardware/gnss/V1_0/IGnssBatching;
    .registers 1
...
.method public static blacklist getService(Ljava/lang/String;)Landroid/hardware/gnss/V1_0/IGnssBatching;
    .registers 2
...
.method public static blacklist getService(Ljava/lang/String;Z)Landroid/hardware/gnss/V1_0/IGnssBatching;
    .registers 3
    .param p0, "serviceName"    # Ljava/lang/String;
    .param p1, "retry"    # Z
    .annotation system Ldalvik/annotation/Throws;
...
.method public static blacklist getService(Z)Landroid/hardware/gnss/V1_0/IGnssBatching;
    .registers 2
    .param p0, "retry"    # Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public abstract blacklist getBatchSize()S
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract blacklist init(Landroid/hardware/gnss/V1_0/IGnssBatchingCallback;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract blacklist start(Landroid/hardware/gnss/V1_0/IGnssBatching$Options;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
