...
.field public blacklist layers:I

.field public blacklist stride:I
...
.method public final blacklist readFromParcel(Landroid/os/Parcel;)V
    ...
    iput v2, p0, Landroid/hardware/graphics/common/HardwareBufferDescription;->width:I
    ...
    iput v2, p0, Landroid/hardware/graphics/common/HardwareBufferDescription;->height:I
    ...
    iput v2, p0, Landroid/hardware/graphics/common/HardwareBufferDescription;->layers:I
    ...
    iput v2, p0, Landroid/hardware/graphics/common/HardwareBufferDescription;->format:I
    ...
    iput-wide v5, p0, Landroid/hardware/graphics/common/HardwareBufferDescription;->usage:J
    ...
    iput v2, p0, Landroid/hardware/graphics/common/HardwareBufferDescription;->stride:I
    :try_end_b8
    ...
    .end local p0    # "this":Landroid/hardware/graphics/common/HardwareBufferDescription;
    ...
    .restart local p0    # "this":Landroid/hardware/graphics/common/HardwareBufferDescription;
...
.method public final whitelist writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 32
    iget v1, p0, Landroid/hardware/graphics/common/HardwareBufferDescription;->width:I

    invoke-virtual {p1, v1}, Landroid/os/Parcel;->writeInt(I)V

    .line 33
    iget v1, p0, Landroid/hardware/graphics/common/HardwareBufferDescription;->height:I

    invoke-virtual {p1, v1}, Landroid/os/Parcel;->writeInt(I)V

    .line 34
    iget v1, p0, Landroid/hardware/graphics/common/HardwareBufferDescription;->layers:I

    invoke-virtual {p1, v1}, Landroid/os/Parcel;->writeInt(I)V

    .line 35
    iget v1, p0, Landroid/hardware/graphics/common/HardwareBufferDescription;->format:I

    invoke-virtual {p1, v1}, Landroid/os/Parcel;->writeInt(I)V

    .line 36
    iget-wide v1, p0, Landroid/hardware/graphics/common/HardwareBufferDescription;->usage:J

    invoke-virtual {p1, v1, v2}, Landroid/os/Parcel;->writeLong(J)V

    .line 37
    iget v1, p0, Landroid/hardware/graphics/common/HardwareBufferDescription;->stride:I
