...
# virtual methods
.method public blacklist addEscrowToken([BI)V
    .registers 3
    .param p1, "token"    # [B
    .param p2, "userId"    # I
...
.method public blacklist isEscrowTokenActive(JI)V
    .registers 4
    .param p1, "handle"    # J
    .param p3, "userId"    # I
    .annotation system Ldalvik/annotation/Throws;
...
.method public blacklist onConfigureCompleted(ZLandroid/os/IBinder;)V
    .registers 3
    .param p1, "result"    # Z
...
.method public blacklist removeEscrowToken(JI)V
    .registers 4
    .param p1, "handle"    # J
    .param p3, "userId"    # I
    .annotation system Ldalvik/annotation/Throws;
...
.method public blacklist revokeTrust()V
    .registers 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public blacklist setManagingTrust(Z)V
    .registers 2
...
.method public blacklist showKeyguardErrorMessage(Ljava/lang/CharSequence;)V
    .registers 2
    .param p1, "message"    # Ljava/lang/CharSequence;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public blacklist unlockUserWithToken(J[BI)V
    .registers 5
    .param p1, "handle"    # J
    .param p3, "token"    # [B
    .param p4, "userId"    # I
