...
.method static greylist-max-o readFrom(Landroid/os/Parcel;)Landroid/net/Uri;
    ...
    .line 1209
    .local v7, "authority":Landroid/net/Uri$Part;
    if-eqz v6, :cond_10
    ...
    :cond_10
    invoke-virtual {v7}, Landroid/net/Uri$Part;->isEmpty()Z
    ...
    .line 1211
    .local v8, "hasSchemeOrAuthority":Z
    invoke-static {v8, p0}, Landroid/net/Uri$PathPart;->readFrom(ZLandroid/os/Parcel;)Landroid/net/Uri$PathPart;

    move-result-object v9

    .line 1212
    .local v9, "path":Landroid/net/Uri$PathPart;
    invoke-static {p0}, Landroid/net/Uri$Part;->readFrom(Landroid/os/Parcel;)Landroid/net/Uri$Part;

    move-result-object v10

    .line 1213
    .local v10, "query":Landroid/net/Uri$Part;
    invoke-static {p0}, Landroid/net/Uri$Part;->readFrom(Landroid/os/Parcel;)Landroid/net/Uri$Part;

    move-result-object v11

    .line 1214
    .local v11, "fragment":Landroid/net/Uri$Part;
    new-instance v12, Landroid/net/Uri$HierarchicalUri;
