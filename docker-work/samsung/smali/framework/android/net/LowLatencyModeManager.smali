...
.method public blacklist getLowLatencyMode(ILandroid/net/LowLatencyModeManager$LatencyCallback;)V
    ...
    :try_end_35
    .catch Ljava/io/IOException; {:try_start_29 .. :try_end_35} :catch_cd
    ...
    :try_end_9c
    .catch Landroid/os/RemoteException; {:try_start_81 .. :try_end_9c} :catch_af
    ...
    .catch Ljava/lang/NullPointerException; {:try_start_9e .. :try_end_a1} :catch_a2
    .catch Landroid/os/RemoteException; {:try_start_9e .. :try_end_a1} :catch_af
    ...
    :try_end_ab
    .catch Landroid/os/RemoteException; {:try_start_a3 .. :try_end_ab} :catch_af
...
.method public blacklist setLowLatencyMode(IIIZZ)V
    ...
    invoke-virtual {v1, v2}, Ljava/io/DataOutputStream;->writeByte(I)V
    :try_end_4c
    .catch Ljava/io/IOException; {:try_start_29 .. :try_end_4c} :catch_f9
    ...
    invoke-direct {p0, v6}, Landroid/net/LowLatencyModeManager;->loge(Ljava/lang/String;)V
    :try_end_dd
    .catch Landroid/os/RemoteException; {:try_start_c4 .. :try_end_dd} :catch_f0
    ...
    :try_end_e2
    .catch Ljava/lang/InterruptedException; {:try_start_df .. :try_end_e2} :catch_e8
    .catch Ljava/lang/NullPointerException; {:try_start_df .. :try_end_e2} :catch_e3
    .catch Landroid/os/RemoteException; {:try_start_df .. :try_end_e2} :catch_f0
    ...
    :try_end_ec
    .catch Landroid/os/RemoteException; {:try_start_e4 .. :try_end_ec} :catch_f0
