...
.method private constructor blacklist <init>(Ljava/lang/String;Ljava/io/FileDescriptor;ZZ)V
    ...
    .line 115
    new-instance v4, Landroid/util/jar/StrictJarVerifier;

    invoke-direct {v4, p1, v3, v2, p4}, Landroid/util/jar/StrictJarVerifier;-><init>(Ljava/lang/String;Landroid/util/jar/StrictJarManifest;Ljava/util/HashMap;Z)V

    iput-object v4, p0, Landroid/util/jar/StrictJarFile;->verifier:Landroid/util/jar/StrictJarVerifier;
    ...
    .end local p0    # "this":Landroid/util/jar/StrictJarFile;
    .end local p1    # "name":Ljava/lang/String;
    .end local p2    # "fd":Ljava/io/FileDescriptor;
    .end local p3    # "verify":Z
    .end local p4    # "signatureSchemeRollbackProtectionsEnforced":Z
    throw v0

    .line 128
    .end local v5    # "file":Ljava/lang/String;
    .restart local p0    # "this":Landroid/util/jar/StrictJarFile;
    .restart local p1    # "name":Ljava/lang/String;
    .restart local p2    # "fd":Ljava/io/FileDescriptor;
    .restart local p3    # "verify":Z
    .restart local p4    # "signatureSchemeRollbackProtectionsEnforced":Z
    :cond_71
    ...
    :try_end_8c
    .catch Ljava/io/IOException; {:try_start_19 .. :try_end_8c} :catch_95
    .catch Ljava/lang/SecurityException; {:try_start_19 .. :try_end_8c} :catch_95
