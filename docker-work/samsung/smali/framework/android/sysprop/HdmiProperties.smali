...
.method public static blacklist arc_port()Ljava/util/Optional;
    .registers 2
    ...
    invoke-static {v0}, Landroid/sysprop/HdmiProperties;->tryParseString(Ljava/lang/String;)Ljava/lang/String;
...
.method public static blacklist cec_device_types()Ljava/util/List;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 187
    const-string/jumbo v0, "ro.hdmi.cec_device_types"
    ...
    .line 188
    .local v0, "value":Ljava/lang/String;
    const-class v1, Landroid/sysprop/HdmiProperties$cec_device_types_values;

    invoke-static {v1, v0}, Landroid/sysprop/HdmiProperties;->tryParseEnumList(Ljava/lang/Class;Ljava/lang/String;)Ljava/util/List;
...
.method public static blacklist device_type()Ljava/util/List;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 165
    .local v0, "value":Ljava/lang/String;
    new-instance v1, Landroid/sysprop/HdmiProperties$$ExternalSyntheticLambda0;

    invoke-direct {v1}, Landroid/sysprop/HdmiProperties$$ExternalSyntheticLambda0;-><init>()V
...
.method public static blacklist forward_volume_keys_when_system_audio_mode_off()Ljava/util/Optional;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public static blacklist is_switch()Ljava/util/Optional;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method static synthetic blacklist lambda$device_type$0(Ljava/lang/String;)Ljava/lang/Integer;
    .registers 2
...
.method public static blacklist playback_device_action_on_routing_control()Ljava/util/Optional;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 221
    .local v0, "value":Ljava/lang/String;
    const-class v1, Landroid/sysprop/HdmiProperties$playback_device_action_on_routing_control_values;

    invoke-static {v1, v0}, Landroid/sysprop/HdmiProperties;->tryParseEnum(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;

    move-result-object v1

    check-cast v1, Landroid/sysprop/HdmiProperties$playback_device_action_on_routing_control_values;
