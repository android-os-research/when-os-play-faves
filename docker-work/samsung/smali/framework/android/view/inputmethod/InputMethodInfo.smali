...
.method public constructor greylist-max-o <init>(Landroid/content/Context;Landroid/content/pm/ResolveInfo;Ljava/util/List;)V
    ...
    move-result v2
    :try_end_41
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_28 .. :try_end_41} :catch_2e3
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_28 .. :try_end_41} :catch_2e3
    .catch Ljava/lang/NumberFormatException; {:try_start_28 .. :try_end_41} :catch_2e3
    .catchall {:try_start_28 .. :try_end_41} :catchall_2d9
    ...
    :try_end_6c
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_54 .. :try_end_6c} :catch_2af
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_54 .. :try_end_6c} :catch_2af
    .catch Ljava/lang/NumberFormatException; {:try_start_54 .. :try_end_6c} :catch_2af
    .catchall {:try_start_54 .. :try_end_6c} :catchall_2a5
    ...
    :try_end_73
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_6f .. :try_end_73} :catch_286
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_6f .. :try_end_73} :catch_286
    .catch Ljava/lang/NumberFormatException; {:try_start_6f .. :try_end_73} :catch_286
    .catchall {:try_start_6f .. :try_end_73} :catchall_27b
    ...
    move-result v16
    :try_end_8b
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_79 .. :try_end_8b} :catch_270
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_79 .. :try_end_8b} :catch_270
    .catch Ljava/lang/NumberFormatException; {:try_start_79 .. :try_end_8b} :catch_270
    .catchall {:try_start_79 .. :try_end_8b} :catchall_265
    ...
    move-result v16
    :try_end_92
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_8e .. :try_end_92} :catch_259
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_8e .. :try_end_92} :catch_259
    .catch Ljava/lang/NumberFormatException; {:try_start_8e .. :try_end_92} :catch_259
    .catchall {:try_start_8e .. :try_end_92} :catchall_24d
    ...
    :try_end_b2
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_96 .. :try_end_b2} :catch_240
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_96 .. :try_end_b2} :catch_240
    .catch Ljava/lang/NumberFormatException; {:try_start_96 .. :try_end_b2} :catch_240
    .catchall {:try_start_96 .. :try_end_b2} :catchall_233
    ...
    move-result v11
    :try_end_c7
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_b6 .. :try_end_c7} :catch_228
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_b6 .. :try_end_c7} :catch_228
    .catch Ljava/lang/NumberFormatException; {:try_start_b6 .. :try_end_c7} :catch_228
    .catchall {:try_start_b6 .. :try_end_c7} :catchall_21d
    ...
    .local v6, "type":I
    if-eq v6, v11, :cond_19b

    .line 261
    const/4 v11, 0x2

    if-ne v6, v11, :cond_189
    ...
    throw v0
    :try_end_189
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_cc .. :try_end_189} :catch_2d1
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_cc .. :try_end_189} :catch_2d1
    .catch Ljava/lang/NumberFormatException; {:try_start_cc .. :try_end_189} :catch_2d1
    .catchall {:try_start_cc .. :try_end_189} :catchall_2c9
    ...
    throw v0
    :try_end_2c9
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_29d .. :try_end_2c9} :catch_2d1
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_29d .. :try_end_2c9} :catch_2d1
    .catch Ljava/lang/NumberFormatException; {:try_start_29d .. :try_end_2c9} :catch_2d1
    .catchall {:try_start_29d .. :try_end_2c9} :catchall_2c9
    ...
    throw v2
    :try_end_309
    .catchall {:try_start_2ec .. :try_end_309} :catchall_309
