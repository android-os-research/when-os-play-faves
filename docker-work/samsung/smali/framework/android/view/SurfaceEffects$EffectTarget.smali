...
.method static constructor blacklist <clinit>()V
    ...
    .line 120
    new-instance v1, Landroid/view/SurfaceEffects$EffectTarget;

    const-string v4, "BEHIND"

    const/4 v5, 0x2

    invoke-direct {v1, v4, v3, v5}, Landroid/view/SurfaceEffects$EffectTarget;-><init>(Ljava/lang/String;II)V

    sput-object v1, Landroid/view/SurfaceEffects$EffectTarget;->BEHIND:Landroid/view/SurfaceEffects$EffectTarget;

    .line 121
    new-instance v4, Landroid/view/SurfaceEffects$EffectTarget;

    const-string v6, "SELF_AND_BEHIND"

    const/4 v7, 0x3

    invoke-direct {v4, v6, v5, v7}, Landroid/view/SurfaceEffects$EffectTarget;-><init>(Ljava/lang/String;II)V

    sput-object v4, Landroid/view/SurfaceEffects$EffectTarget;->SELF_AND_BEHIND:Landroid/view/SurfaceEffects$EffectTarget;

    .line 118
    new-array v6, v7, [Landroid/view/SurfaceEffects$EffectTarget;
    ...
    sput-object v6, Landroid/view/SurfaceEffects$EffectTarget;->$VALUES:[Landroid/view/SurfaceEffects$EffectTarget;
