...
.method public whitelist createAnimator(Landroid/view/ViewGroup;Landroid/transition/TransitionValues;Landroid/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    .local v17, "endDrawable":Landroid/graphics/drawable/BitmapDrawable;
    new-array v1, v10, [F
    ...
    .line 215
    .end local v17    # "endDrawable":Landroid/graphics/drawable/BitmapDrawable;
    ...
    .line 222
    .end local v1    # "endDrawable":Landroid/graphics/drawable/BitmapDrawable;
    .restart local v17    # "endDrawable":Landroid/graphics/drawable/BitmapDrawable;
    :goto_bd
    ...
    .end local v17    # "endDrawable":Landroid/graphics/drawable/BitmapDrawable;
    .local v19, "endDrawable":Landroid/graphics/drawable/BitmapDrawable;
    move-object/from16 v1, p0

    move-object/from16 v17, v2

    .end local v2    # "startDrawable":Landroid/graphics/drawable/BitmapDrawable;
    .local v17, "startDrawable":Landroid/graphics/drawable/BitmapDrawable;
    move v2, v11

    move-object/from16 v20, v3

    .end local v3    # "endBitmap":Landroid/graphics/Bitmap;
    .local v20, "endBitmap":Landroid/graphics/Bitmap;
    move-object v3, v12

    move-object/from16 v21, v4

    .end local v4    # "startBitmap":Landroid/graphics/Bitmap;
    .local v21, "startBitmap":Landroid/graphics/Bitmap;
    move-object/from16 v4, v17

    move-object v8, v5

    .end local v5    # "endBounds":Landroid/graphics/Rect;
    .local v8, "endBounds":Landroid/graphics/Rect;
    ...
    .end local v17    # "startDrawable":Landroid/graphics/drawable/BitmapDrawable;
    ...
    .end local v19    # "endDrawable":Landroid/graphics/drawable/BitmapDrawable;
    .local v3, "endDrawable":Landroid/graphics/drawable/BitmapDrawable;
    ...
    .end local v3    # "endDrawable":Landroid/graphics/drawable/BitmapDrawable;
    .restart local v19    # "endDrawable":Landroid/graphics/drawable/BitmapDrawable;
    :cond_12f
    move-object/from16 v3, v19

    .end local v19    # "endDrawable":Landroid/graphics/drawable/BitmapDrawable;
    .restart local v3    # "endDrawable":Landroid/graphics/drawable/BitmapDrawable;
    goto :goto_136
    ...
    .restart local v17    # "startDrawable":Landroid/graphics/drawable/BitmapDrawable;
    .restart local v19    # "endDrawable":Landroid/graphics/drawable/BitmapDrawable;
    :cond_132
    move-object/from16 v10, v17
    ...
    .end local v7    # "anim":Landroid/animation/ObjectAnimator;
    .end local v8    # "endBounds":Landroid/graphics/Rect;
    .end local v9    # "anim1":Landroid/animation/ObjectAnimator;
    .end local v10    # "startDrawable":Landroid/graphics/drawable/BitmapDrawable;
    .end local v18    # "overlay":Landroid/view/ViewOverlay;
    .end local v20    # "endBitmap":Landroid/graphics/Bitmap;
    .end local v21    # "startBitmap":Landroid/graphics/Bitmap;
    .local v1, "endDrawable":Landroid/graphics/drawable/BitmapDrawable;
    .local v2, "startDrawable":Landroid/graphics/drawable/BitmapDrawable;
    .local v3, "endBitmap":Landroid/graphics/Bitmap;
    ...
    .end local v5    # "endBounds":Landroid/graphics/Rect;
    .local v3, "endDrawable":Landroid/graphics/drawable/BitmapDrawable;
    .restart local v8    # "endBounds":Landroid/graphics/Rect;
    .restart local v10    # "startDrawable":Landroid/graphics/drawable/BitmapDrawable;
    .restart local v20    # "endBitmap":Landroid/graphics/Bitmap;
    .restart local v21    # "startBitmap":Landroid/graphics/Bitmap;
    return-object v0
