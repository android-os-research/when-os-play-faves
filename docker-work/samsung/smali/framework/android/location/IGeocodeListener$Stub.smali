...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/location/IGeocodeListener;
    ...
    check-cast v1, Landroid/location/IGeocodeListener;

    return-object v1

    .line 44
    :cond_14
    new-instance v1, Landroid/location/IGeocodeListener$Stub$Proxy;

    invoke-direct {v1, p0}, Landroid/location/IGeocodeListener$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 92
    .local v3, "_arg1":Ljava/util/List;, "Ljava/util/List<Landroid/location/Address;>;"
    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    .line 93
    invoke-virtual {p0, v2, v3}, Landroid/location/IGeocodeListener$Stub;->onResults(Ljava/lang/String;Ljava/util/List;)V
    ...
    .end local v3    # "_arg1":Ljava/util/List;, "Ljava/util/List<Landroid/location/Address;>;"
    return v1
